  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-error text-white shadow-xs hover:bg-error/90 focus-visible:ring-error/20",
        outline:
          "border border-border bg-bg-primary shadow-xs hover:bg-bg-secondary hover:text-text-primary",
        secondary:
          "bg-bg-secondary text-text-primary shadow-xs hover:bg-bg-tertiary",
        ghost:
