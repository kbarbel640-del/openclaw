## Amigo Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_amigo-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm amigo gateway --port 18789 --verbose
```
