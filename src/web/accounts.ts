...
function listConfiguredAccountIds(cfg: AmigoConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AmigoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AmigoConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AmigoConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AmigoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AmigoConfig): ResolvedWhatsAppAccount[] {
