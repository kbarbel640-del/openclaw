...
export function createWebOnMessageHandler(params: {
  ...
  return async (msg: WebInboundMsg) => {
    ...
    if (msg.contextOnly && msg.chatType === "group") {
      ...
      // Still track member names so the agent knows who's in the group
      const { noteGroupMember } = await import("./group-members.js");
      noteGroupMember(params.groupMemberNames, groupHistoryKey, msg.senderE164, msg.senderName);
