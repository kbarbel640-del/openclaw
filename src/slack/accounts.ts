...
export function listSlackAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: AmigoConfig): string {
...
function mergeSlackAccountConfig(cfg: AmigoConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AmigoConfig): ResolvedSlackAccount[] {
