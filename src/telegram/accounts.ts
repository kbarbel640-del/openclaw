...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AMIGO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AmigoConfig): string {
...
function mergeTelegramAccountConfig(cfg: AmigoConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AmigoConfig): ResolvedTelegramAccount[] {
