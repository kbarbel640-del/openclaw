...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "amigo-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AmigoConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AmigoConfig["telegram"]>>,
