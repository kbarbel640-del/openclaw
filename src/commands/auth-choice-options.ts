...
const AUTH_CHOICE_GROUP_DEFS: {
  ...
  },
  {
    value: "google",
    label: "Google",
    hint: "Gemini CLI OAuth + Antigravity + API key",
    choices: ["gemini-cli", "antigravity", "gemini-api-key"],
  },
  {
    value: "openrouter",
    label: "OpenRouter",
...
export function buildAuthChoiceOptions(params: {
  ...
  options.push({
    value: "gemini-cli",
    label: "Gemini CLI OAuth (Gemini 3 Pro Preview)",
    hint: "Uses Google OAuth",
  });
  options.push({
    value: "antigravity",
