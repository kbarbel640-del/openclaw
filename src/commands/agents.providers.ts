...
function resolveDefaultAccountId(cfg: AmigoConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AmigoConfig): boolean {
...
export function summarizeBindings(cfg: AmigoConfig, bindings: AgentBinding[]): string[] {
