...
export function applyZaiConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyOpenrouterProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyOpenrouterConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyMoonshotProviderConfig(cfg: AmigoConfig): AmigoConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AmigoConfig): AmigoConfig {
...
export function applyMoonshotConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyMoonshotConfigCn(cfg: AmigoConfig): AmigoConfig {
...
export function applyKimiCodeProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applySyntheticProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyXiaomiProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AmigoConfig): AmigoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyXaiProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AmigoConfig): AmigoConfig {
...
export function applyQianfanProviderConfig(cfg: AmigoConfig): AmigoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AmigoConfig): AmigoConfig {
