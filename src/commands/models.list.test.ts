...
const ensureAmigoModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAmigoAgentDir = vi.fn().mockReturnValue("/tmp/amigo-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/amigo-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAmigoModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAmigoAgentDir,
}));
