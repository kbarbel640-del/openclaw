...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.amigo.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("amigo hooks list")}`,
      `  ${formatCliCommand("amigo hooks enable <name>")}`,
      `  ${formatCliCommand("amigo hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
