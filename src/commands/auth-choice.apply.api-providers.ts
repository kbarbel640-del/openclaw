...
const API_KEY_TOKEN_PROVIDER_AUTH_CHOICE: Record<string, AuthChoice> = {
  ...
  "nebius-token-factory": "nebius-token-factory-api-key",
...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "nebius-token-factory-api-key": {
    ...
    expectedProviders: ["nebius-token-factory"],
    envLabel: "NEBIUS_TOKEN_FACTORY",
    promptMessage: "Enter Nebius Token Factory API key",
    setCredential: setNebiusTokenFactoryApiKey,
