...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "stepfun-api-key": {
    ...
    expectedProviders: ["stepfun"],
    envLabel: "STEPFUN_API_KEY",
    promptMessage: "Enter StepFun API key",
    setCredential: setStepfunApiKey,
  ...
  "stepfun-cn": {
    ...
    expectedProviders: ["stepfun"],
    envLabel: "STEPFUN_API_KEY",
    promptMessage: "Enter StepFun API key (CN)",
    setCredential: setStepfunApiKey,
    defaultModel: STEPFUN_DEFAULT_MODEL_REF,
    applyDefaultConfig: (cfg) => applyStepfunConfig(cfg, { endpoint: "cn" }),
    applyProviderConfig: (cfg) => applyStepfunProviderConfig(cfg, { endpoint: "cn" }),
    noteDefault: STEPFUN_DEFAULT_MODEL_REF,
  },
  "kimi-code-api-key": {
