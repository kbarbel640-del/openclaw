...
function resolveConfiguredModelRaw(cfg: AmigoConfig): string {
...
function resolveConfiguredModelKeys(cfg: AmigoConfig): string[] {
...
export function applyPrimaryModel(cfg: AmigoConfig, model: string): AmigoConfig {
...
export function applyModelAllowlist(cfg: AmigoConfig, models: string[]): AmigoConfig {
  const defaults = cfg.agents?.defaults;
