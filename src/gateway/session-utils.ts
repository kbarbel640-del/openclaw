...
import { type AmigoConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AmigoConfig): string[] {
...
export function listAgentsForGateway(cfg: AmigoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AmigoConfig): string {
...
function resolveSessionStoreAgentId(cfg: AmigoConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AmigoConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AmigoConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AmigoConfig): GatewaySessionsDefaults {
