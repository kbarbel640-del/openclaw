...
describe("isSecureWebSocketUrl", () => {
  it("accepts secure websocket/loopback ws URLs and rejects unsafe inputs", () => {
    const cases = [
      ...
      { input: "ws://[::ffff:127.0.0.1]:18789", expected: true },
      ...
      { input: "ws://0.0.0.0:18789", expected: false },
      { input: "ws://[::]:18789", expected: false },
      { input: "ws://localhost.example:18789", expected: false },
      { input: "ws://127.0.0.1.nip.io:18789", expected: false },
      // WHATWG URL parser canonicalizes these forms to 127.0.0.1.
      { input: "ws://127.1:18789", expected: true },
      { input: "ws://2130706433:18789", expected: true },
      { input: "ws://0x7f000001:18789", expected: true },
      { input: "ws://[::ffff:192.168.1.10]:18789", expected: false },
