...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @amigo/voice-call -> voice-call).
...
export function discoverAmigoPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".amigo", "extensions")];
