...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@amigo", { botUsername: "amigo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@amigo args", {
        botUsername: "amigo",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "amigo" })).toBe(
      "/help@otherbot",
    );
  });
