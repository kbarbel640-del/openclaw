...
import type { AmigoPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AmigoPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AmigoPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
