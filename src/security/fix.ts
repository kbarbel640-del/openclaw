...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AmigoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AmigoConfig; env: NodeJS.ProcessEnv }): {
  cfg: AmigoConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
