...
export const DEFAULT_LOG_DIR = "/tmp/amigo";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "amigo.log"); // legacy single-file path

const LOG_PREFIX = "amigo";
...
function resolveSettings(): ResolvedSettings {
  let cfg: AmigoConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => AmigoConfig;
      };
