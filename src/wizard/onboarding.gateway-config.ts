...
import type { GatewayBindMode, GatewayTailscaleMode, AmigoConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.amigo.ai/gateway/tailscale", "https://docs.amigo.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
