...
export function getSlashCommands(options: SlashCommandOptions = {}): SlashCommand[] {
  ...
  const commands: SlashCommand[] = [
    ...
    { name: "image", description: "Attach image file: /image <path> [message]" },
    { name: "img", description: "Alias for /image" },
    { name: "attach", description: "Alias for /image" },
    { name: "detach", description: "Clear pending image attachments" },
...
export function helpText(options: SlashCommandOptions = {}): string {
  ...
  return [
    ...
    "/image <path> [message] (or /img, /attach)",
    "/detach (clear pending images)",
    "/new or /reset",
    "/abort",
    "/settings",
    "/exit",
