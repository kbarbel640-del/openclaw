...
export function listBindings(cfg: AmigoConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: AmigoConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AmigoConfig) {
