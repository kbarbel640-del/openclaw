...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "amigo-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAmigoPackageRoot } = await import("./amigo-root.js");
    ...
    vi.mocked(resolveAmigoPackageRoot).mockResolvedValue("/opt/amigo");
