...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: AmigoConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: AmigoConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: AmigoConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: AmigoConfig): void {
