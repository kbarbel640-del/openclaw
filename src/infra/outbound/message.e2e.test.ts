...
describe("sendMessage channel normalization", () => {
  ...
  it("normalizes Teams alias", async () => {
    ...
    expect(sendMSTeams).toHaveBeenCalledWith("conversation:19:[redacted-email]2", "hi");
  ...
  it("normalizes iMessage alias", async () => {
    ...
    expect(sendIMessage).toHaveBeenCalledWith("[redacted-email]", "hi", expect.any(Object));
