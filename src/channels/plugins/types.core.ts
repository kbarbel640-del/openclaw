...
export type ChannelAgentToolFactory = (params: { cfg?: AmigoConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AmigoConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AmigoConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AmigoConfig }) => boolean;
  supportsCards?: (params: { cfg: AmigoConfig }) => boolean;
