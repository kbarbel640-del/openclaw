...
export function listSignalAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AmigoConfig): string {
...
function mergeSignalAccountConfig(cfg: AmigoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AmigoConfig): ResolvedSignalAccount[] {
