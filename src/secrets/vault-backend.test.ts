...
describe("vault-backend", () => {
  describe("createVaultBackend", () => {
    ...
    test("throws 'not yet implemented' for '1password'", () => {
      expect(() => createVaultBackend("1password")).toThrow("1Password backend not yet implemented");
    });

    test("throws 'not yet implemented' for 'bitwarden'", () => {
      expect(() => createVaultBackend("bitwarden")).toThrow("Bitwarden backend not yet implemented");
    });

    test("throws 'not yet implemented' for 'vault'", () => {
      expect(() => createVaultBackend("vault")).toThrow("HashiCorp Vault backend not yet implemented");
    });

    test("throws 'Unknown vault backend' for invalid type", () => {
      expect(() => createVaultBackend("invalid-backend")).toThrow("Unknown vault backend: invalid-backend");
    });
