...
describe("base32Decode", () => {
  test("decodes valid Base32 strings", () => {
    ...
    expect(base32Decode("MZXQ").toString("hex")).toBe("667a");
    expect(base32Decode("MZXW6").toString("hex")).toBe("667a79");
    expect(base32Decode("MZXW6YQ").toString("hex")).toBe("667a7960");
    expect(base32Decode("MZXW6YTB").toString("hex")).toBe("667a796261");
    expect(base32Decode("MZXW6YTBOI").toString("hex")).toBe("667a79626172");
  });
  ...
  test("ignores spaces and dashes", () => {
    expect(base32Decode("MZXW 6YTB OI").toString("hex")).toBe("667a79626172");
    expect(base32Decode("MZXW-6YTB-OI").toString("hex")).toBe("667a79626172");
    expect(base32Decode("MZXW 6YTB-OI").toString("hex")).toBe("667a79626172");
  });
