...
export function listIMessageAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: AmigoConfig): string {
...
function mergeIMessageAccountConfig(cfg: AmigoConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AmigoConfig): ResolvedIMessageAccount[] {
