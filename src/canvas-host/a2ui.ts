...
export const A2UI_PATH = "/__amigo__/a2ui";

export const CANVAS_HOST_PATH = "/__amigo__/canvas";

export const CANVAS_WS_PATH = "/__amigo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.amigoCanvasA2UIAction.postMessage(...)
  // - Android: window.amigoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["amigoCanvasA2UIAction"];
  ...
  globalThis.Amigo = globalThis.Amigo ?? {};
  globalThis.Amigo.postMessage = postToNode;
  globalThis.Amigo.sendUserAction = sendUserAction;
  globalThis.amigoPostMessage = postToNode;
  globalThis.amigoSendUserAction = sendUserAction;
