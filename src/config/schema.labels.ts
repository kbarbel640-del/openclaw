...
export const FIELD_LABELS: Record<string, string> = {
  ...
  policy: "Signed Policy Guardrails",
  "policy.enabled": "Enable Signed Policy Guardrails",
  "policy.policyPath": "Signed Policy File Path",
  "policy.sigPath": "Signed Policy Signature Path",
  "policy.publicKey": "Policy Verification Public Key",
  "policy.failClosed": "Policy Fail-Closed Mode",
