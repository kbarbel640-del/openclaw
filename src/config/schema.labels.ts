...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.controlUi.csp": "Control UI CSP",
  "gateway.controlUi.csp.scriptSrcExtra": "Control UI CSP Script Sources (Extra)",
  "gateway.controlUi.csp.styleSrcExtra": "Control UI CSP Style Sources (Extra)",
  "gateway.controlUi.csp.styleSrcElemExtra": "Control UI CSP Style-Src-Elem Sources (Extra)",
  "gateway.controlUi.csp.imgSrcExtra": "Control UI CSP Image Sources (Extra)",
  "gateway.controlUi.csp.fontSrcExtra": "Control UI CSP Font Sources (Extra)",
  "gateway.controlUi.csp.connectSrcExtra": "Control UI CSP Connect Sources (Extra)",
  "gateway.controlUi.csp.workerSrcExtra": "Control UI CSP Worker Sources (Extra)",
