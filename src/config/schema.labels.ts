...
export const FIELD_LABELS: Record<string, string> = {
  ...
  opik: "Opik",
  "opik.enabled": "Opik Enabled",
  "opik.apiKey": "Opik API Key",
  "opik.apiUrl": "Opik API URL",
  "opik.projectName": "Opik Project Name",
  "opik.workspaceName": "Opik Workspace Name",
  "opik.tags": "Opik Trace Tags",
