...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "auth.cooldowns.billingBackoff": "Billing Backoff",
  "auth.cooldowns.billingBackoffByProvider": "Billing Backoff Overrides",
  "auth.cooldowns.billingMax": "Billing Backoff Cap",
  "auth.cooldowns.billingRecoveryMode": "Billing Recovery Mode",
  "auth.cooldowns.failureWindow": "Failover Window",
