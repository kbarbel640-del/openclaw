...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "talk.providers.*.seed": "Talk Provider Seed",
  "talk.providers.*.voiceSettings": "Talk Provider Voice Settings",
  "talk.providers.*.voiceSettings.stability": "Stability",
  "talk.providers.*.voiceSettings.similarityBoost": "Similarity Boost",
  "talk.providers.*.voiceSettings.style": "Style",
  "talk.providers.*.voiceSettings.useSpeakerBoost": "Speaker Boost",
  "talk.providers.*.voiceSettings.speed": "Speed",
  "talk.providers.*.applyTextNormalization": "Text Normalization",
  "talk.providers.*.languageCode": "Language Code",
  "talk.providers.*.model": "Talk Provider Model",
  "talk.providers.*.voice": "Talk Provider Voice",
  "talk.elevenlabs": "Talk ElevenLabs Config",
  "talk.openai": "Talk OpenAI Config",
