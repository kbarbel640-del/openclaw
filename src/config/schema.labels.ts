...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.elevated.criticalApproval.enabled": "Critical Approval Gate",
  "tools.elevated.criticalApproval.requireControlUi": "Critical Approval Control UI Only",
  "tools.elevated.criticalApproval.breakGlassEnv": "Critical Approval Break-Glass Env",
