...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.abuse": "Gateway Abuse Hardening",
  "gateway.abuse.quota": "Gateway Abuse Unified Quotas",
  "gateway.abuse.quota.mode": "Gateway Abuse Quota Mode",
  "gateway.abuse.quota.burstLimit": "Gateway Abuse Quota Burst Limit",
  "gateway.abuse.quota.burstWindowMs": "Gateway Abuse Quota Burst Window (ms)",
  "gateway.abuse.quota.sustainedLimit": "Gateway Abuse Quota Sustained Limit",
  "gateway.abuse.quota.sustainedWindowMs": "Gateway Abuse Quota Sustained Window (ms)",
  "gateway.abuse.anomaly": "Gateway Abuse Semantic Anomaly",
  "gateway.abuse.anomaly.mode": "Gateway Abuse Anomaly Mode",
  "gateway.abuse.anomaly.warningThreshold": "Gateway Abuse Anomaly Warning Threshold",
  "gateway.abuse.anomaly.throttleThreshold": "Gateway Abuse Anomaly Throttle Threshold",
  "gateway.abuse.anomaly.blockThreshold": "Gateway Abuse Anomaly Block Threshold",
  "gateway.abuse.anomaly.blockDurationMs": "Gateway Abuse Anomaly Block Duration (ms)",
  "gateway.abuse.correlation": "Gateway Abuse Correlation",
  "gateway.abuse.correlation.mode": "Gateway Abuse Correlation Mode",
  "gateway.abuse.correlation.windowMs": "Gateway Abuse Correlation Window (ms)",
  "gateway.abuse.correlation.decayHalfLifeMs": "Gateway Abuse Correlation Decay Half-life (ms)",
  "gateway.abuse.correlation.warningScore": "Gateway Abuse Correlation Warning Score",
  "gateway.abuse.correlation.criticalScore": "Gateway Abuse Correlation Critical Score",
  "gateway.abuse.incident": "Gateway Abuse Incident Workflow",
  "gateway.abuse.incident.mode": "Gateway Abuse Incident Mode",
  "gateway.abuse.incident.autoContainment": "Gateway Abuse Auto-containment",
  "gateway.abuse.incident.autoContainment.enabled": "Gateway Abuse Auto-containment Enabled",
  "gateway.abuse.incident.autoContainment.minSeverity":
    "Gateway Abuse Auto-containment Minimum Severity",
  "gateway.abuse.incident.autoContainment.ttlMs": "Gateway Abuse Auto-containment Duration (ms)",
  "gateway.abuse.incident.retentionDays": "Gateway Abuse Incident Retention (days)",
  "gateway.abuse.auditLedger": "Gateway Abuse Audit Ledger",
  "gateway.abuse.auditLedger.mode": "Gateway Abuse Audit Ledger Mode",
  "gateway.abuse.auditLedger.retentionDays": "Gateway Abuse Audit Ledger Retention (days)",
  "gateway.abuse.auditLedger.maxRecords": "Gateway Abuse Audit Ledger Max Records",
  "gateway.abuse.auditLedger.redactPayloads": "Gateway Abuse Audit Ledger Redact Payloads",
