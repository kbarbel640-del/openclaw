...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.model.routing": "Task-Based Model Routing",
  "agents.defaults.model.routing.enabled": "Task Routing Enabled",
  "agents.defaults.model.routing.rules": "Task Routing Rules",
  "agents.defaults.model.routing.fallbackToPrimary": "Task Routing Fallback to Primary",
