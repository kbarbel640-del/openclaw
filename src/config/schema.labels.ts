...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.remote.baseUrl": "Remote Memory Base URL",
  "memory.remote.apiKey": "Remote Memory API Key",
  "memory.remote.headers": "Remote Memory Extra Headers",
  "memory.remote.vectorStoreId": "Remote Memory Vector Store ID",
  "memory.remote.vectorStoreName": "Remote Memory Vector Store Name",
  "memory.remote.syncIntervalMs": "Remote Memory Sync Interval (ms)",
  "memory.remote.searchMaxResults": "Remote Memory Max Results",
  "memory.remote.searchScoreThreshold": "Remote Memory Score Threshold",
  auth: "Auth",
