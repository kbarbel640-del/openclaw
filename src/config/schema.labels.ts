...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.telegram.reactions": "Telegram Status Reactions",
  "channels.telegram.reactions.enabled": "Telegram Status Reactions Enabled",
  "channels.telegram.reactions.mode": "Telegram Status Reactions Mode",
  "channels.telegram.reactions.phases": "Telegram Status Reaction Phases",
