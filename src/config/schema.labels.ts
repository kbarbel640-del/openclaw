...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.compaction.audit": "Post-Compaction Audit",
  "agents.defaults.compaction.audit.enabled": "Post-Compaction Audit Enabled",
  "agents.defaults.compaction.audit.channel": "Post-Compaction Audit Channel",
  "agents.defaults.compaction.audit.silent": "Post-Compaction Audit Silent",
