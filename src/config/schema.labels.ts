...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.model.primaryRecovery": "Primary Recovery",
  "agents.defaults.model.primaryRecovery.probeIntervalMs": "Primary Recovery Probe Interval (ms)",
  "agents.defaults.model.primaryRecovery.autoReturn": "Auto-Return to Primary",
