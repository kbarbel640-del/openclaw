...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "skills.entries.*.enabled": "Skill Enabled",
  "skills.entries.*.apiKey": "Skill API Key",
  "skills.entries.*.env": "Skill Env",
  "skills.entries.*.config": "Skill Config",
  "skills.entries.*.*": "Skill config key",
