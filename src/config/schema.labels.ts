...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "messages.groupChat.turnTaking": "Group Chat Turn-Taking",
  "messages.groupChat.turnTaking.maxDepth": "Turn-Taking Max Depth",
  "messages.groupChat.turnTaking.cooldownMs": "Turn-Taking Cooldown (ms)",
  ...
  "channels.telegram.multiAgentGroup": "Telegram Multi-Agent Group",
  "channels.telegram.multiAgentGroup.enabled": "Multi-Agent Group Enabled",
  "channels.telegram.multiAgentGroup.allowAgentBotIds": "Allow Agent Bot IDs",
