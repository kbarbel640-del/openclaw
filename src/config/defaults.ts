...
function resolveAnthropicDefaultAuthMode(cfg: AmigoConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AmigoConfig): AmigoConfig {
...
export function applyTalkApiKey(config: AmigoConfig): AmigoConfig {
...
export function applyModelDefaults(cfg: AmigoConfig): AmigoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AmigoConfig): AmigoConfig {
...
export function applyLoggingDefaults(cfg: AmigoConfig): AmigoConfig {
...
export function applyContextPruningDefaults(cfg: AmigoConfig): AmigoConfig {
...
export function applyCompactionDefaults(cfg: AmigoConfig): AmigoConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
