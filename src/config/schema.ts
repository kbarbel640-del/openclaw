...
const _FIELD_LABELS: Record<string, string> = {
  ...
  "skills.limits.maxCandidatesPerRoot": "Skills Max Candidates per Root",
  "skills.limits.maxSkillsLoadedPerSource": "Skills Max Loaded per Source",
  "skills.limits.maxSkillsInPrompt": "Skills Max In Prompt",
  "skills.limits.maxSkillsPromptChars": "Skills Prompt Max Chars",
  "skills.limits.maxSkillFileBytes": "Skills Max SKILL.md Bytes",
...
const _FIELD_HELP: Record<string, string> = {
  ...
  "skills.limits.maxCandidatesPerRoot":
    "Safety guardrail. If a skills root has more than this many child directories, OpenClaw will treat it as suspicious and avoid scanning everything.",
  "skills.limits.maxSkillsLoadedPerSource":
    "Safety guardrail. Caps how many skills can be loaded from each skills source (bundled/managed/workspace/extra).",
  "skills.limits.maxSkillsInPrompt":
    "Safety guardrail. Caps how many skills can be included in the model-facing skills prompt.",
  "skills.limits.maxSkillsPromptChars":
    "Safety guardrail. Caps the character length of the model-facing skills prompt block.",
  "skills.limits.maxSkillFileBytes":
    "Safety guardrail. Skip skills whose SKILL.md file exceeds this size (bytes).",
