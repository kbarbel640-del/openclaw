...
const FIELD_LABELS: Record<string, string> = {
  ...
  "security.secretScanning.mode": "Secret Scanning Mode",
  "security.secretScanning.maxChars": "Secret Scanning Max Chars",
  "security.secretScanning.overflow": "Secret Scanning Overflow",
  "security.secretScanning.logSecretMatches": "Secret Scanning Log Matches",
