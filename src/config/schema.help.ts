...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "perplexity", "grok", "gemini", "kimi", or "searxng"). Auto-detected from available API keys if omitted. Use "searxng" for self-hosted, API-key-free search.',
