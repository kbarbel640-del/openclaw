...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.openai.apiKey":
    "OpenAI API key for web search (fallback: OPENAI_API_KEY env var).",
  "tools.web.search.openai.model": 'OpenAI model override (default: "gpt-5.2").',
  "tools.web.search.openai.baseUrl":
    'OpenAI base URL override (default: "https://api.openai.com").',
