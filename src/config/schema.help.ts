...
export const FIELD_HELP: Record<string, string> = {
  ...
  "ui.user":
    "User display identity settings for name and avatar shown in UI surfaces. Customize how your own messages appear in the Control UI chat.",
  "ui.user.name":
    "Display name shown for the user in UI views and chat chrome. Defaults to 'You' when not set.",
  "ui.user.avatar":
    "User avatar image source used in UI surfaces (URL, path, or data URI depending on runtime support). Use trusted assets and consistent branding dimensions for clean rendering.",
  plugins:
