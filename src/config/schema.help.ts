...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.brave.apiKey":
    "Brave Search API key override (fallback: tools.web.search.apiKey, then BRAVE_API_KEY env var).",
  "tools.web.search.brave.baseUrl": "Brave Search base URL override (provider-specific).",
