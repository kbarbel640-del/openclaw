...
function resolveAvatarSource(cfg: AmigoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AmigoConfig, agentId: string): AgentAvatarResolution {
