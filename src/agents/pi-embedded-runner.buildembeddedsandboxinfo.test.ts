...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies AmigoConfig;

const _ensureModels = (cfg: AmigoConfig, agentDir: string) =>
  ensureAmigoModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/amigo-sandbox",
      agentWorkspaceDir: "/tmp/amigo-workspace",
      ...
      browser: {
        ...
        containerName: "amigo-sbx-browser-test",
      },
