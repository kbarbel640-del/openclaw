...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createAmigoCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createAmigoCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createAmigoCodingTools({
      config: cfg,
    ...
    const defaultTools = createAmigoCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createAmigoCodingTools({
      config: cfg,
    ...
    const bobTools = createAmigoCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createAmigoCodingTools({
      config: cfg,
