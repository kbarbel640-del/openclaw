...
export const DEFAULT_SANDBOX_IMAGE = "amigo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "amigo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "amigo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "amigo-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "amigo-sbx-browser-";
