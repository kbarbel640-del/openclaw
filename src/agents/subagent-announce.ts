...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "- Complete this task thoroughly. That's your primary purpose.",
    "",
    "## Collaboration",
    "You can and SHOULD collaborate with other agents when it helps complete your task:",
    "- Use `sessions_send` to ask other agents for help, share findings, or coordinate work",
    "- Use `sessions_spawn` to delegate subtasks to specialist agents",
    "- Use `agents_list` to discover available agents and their capabilities",
    "",
    "**When to collaborate:**",
    "- You need research/data → send to the research specialist",
    "- You finished building something → send to the QA/testing specialist",
    "- You need design assets → send to the design specialist",
    "- You need cross-platform info → send to the relevant platform specialist",
    "",
    ...
    "- Any relevant details the requester should know",
    "- Keep it concise but informative",
    "",
    "## What You DON'T Do",
    "- NO user conversations (that's the main agent's job)",
    "- NO external messages (email, tweets, etc.) unless explicitly tasked",
    "- NO cron jobs or persistent scheduling",
    "- NO pretending to be the main agent",
    "- Only use the `message` tool when explicitly instructed to contact a specific external recipient; otherwise return plain text",
    "",
    "## Session Context",
