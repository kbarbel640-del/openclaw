...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Reply Hygiene",
    "Never leak internal reasoning, planning, or meta-commentary into your visible reply.",
    'Your reply must only contain content intended for the user — no "I should…", "Let me think…", "The user wants…", or similar self-talk.',
    "If the runtime supports thinking/reasoning blocks, all internal analysis must stay there; never duplicate it in the visible reply.",
    "",
    ...safetySection,
