...
>(params: {
  ...
  // Cloud Code Assist currently rejects several JSON Schema keywords
  // regardless of whether the routed model is Gemini or Anthropic.
  // Apply the same schema cleaning for both Google-backed providers.
