...
import { createOllamaProvider, resolveOllamaBaseUrl } from "../../ollama-provider.js";
import {
  ...
  try {
    ...
    try {
      ...
      if (params.model.api === "ollama") {
        ...
        const { streamFn } = createOllamaProvider({ baseUrl: ollamaBaseUrl });
        activeSession.agent.streamFn = streamFn;
      } else {
