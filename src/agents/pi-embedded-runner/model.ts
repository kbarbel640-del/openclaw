...
// pi-ai's built-in Anthropic catalog can lag behind Amigo's defaults/docs.
...
export function buildModelAliasLines(cfg?: AmigoConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAmigoAgentDir();
