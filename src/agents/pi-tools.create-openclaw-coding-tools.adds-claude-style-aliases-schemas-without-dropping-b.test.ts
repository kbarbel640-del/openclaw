...
describe("createAmigoCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAmigoCodingTools({
      config,
    ...
    const anthropicTools = createAmigoCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAmigoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAmigoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
