export const pt = {
  ...
  usage: {
    ...
    model: "Modelo",
    tool: "Ferramenta",
    filterHint: "Dica: use filtros ou clique nas barras para filtrar os dias.",
  },
  ...
  // Channels
  channels: {
    health: "Saúde dos canais",
    healthSubtitle: "Snapshots de status dos canais vindos do gateway.",
