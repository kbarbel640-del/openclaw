  ...
  const renderPicturePreview = () => {
    ...
    return html`
      <div style="margin-bottom: 12px;">
        <img
          src=${picture}
          alt=${t("channels.profilePicturePreview")}
  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">${t("channels.editProfile")}</div>
        <div style="font-size: 12px; color: var(--text-muted);">${t("channels.nostrAccount")}: ${accountId}</div>
      </div>
      ...
      ${renderField("about", t("channels.nostrBio"), {
        type: "textarea",
        placeholder: t("channels.nostrAboutPlaceholder"),
        maxLength: 2000,
      ...
      ${renderField("picture", t("channels.nostrAvatarUrl"), {
        ...
        help: t("channels.nostrAvatarHelp"),
      })}
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">${t("channels.advanced")}</div>

              ${renderField("banner", t("channels.nostrBannerUrl"), {
                type: "url",
                placeholder: "https://example.com/banner.jpg",
                help: t("channels.nostrBannerHelp"),
              })}
              ...
              ${renderField("nip05", t("channels.nostrNip05Label"), {
                placeholder: "you@example.com",
                help: t("channels.nostrNip05Help"),
              })}

              ${renderField("lud16", t("channels.nostrLud16Label"), {
                placeholder: "you@getalby.com",
                help: t("channels.nostrLud16Help"),
              })}
            </div>
          `
          : nothing
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.importing ? t("channels.importing") : t("channels.importFromRelays")}
        </button>
