  ...
  const renderPicturePreview = () => {
    ...
    return html`
      <div style="margin-bottom: 12px;">
        <img
          src=${picture}
          alt=${t("channels.nostrForm.profilePicturePreviewAlt")}
  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">${t("channels.nostrForm.title")}</div>
        <div style="font-size: 12px; color: var(--text-muted);">${t("channels.nostrForm.accountLabel", { accountId })}</div>
      </div>
      ...
      ${renderField("name", t("channels.nostrForm.username"), {
        placeholder: t("channels.nostrForm.usernamePlaceholder"),
        maxLength: 256,
        help: t("channels.nostrForm.usernameHelp"),
      })}

      ${renderField("displayName", t("channels.nostrForm.displayName"), {
        placeholder: t("channels.nostrForm.displayNamePlaceholder"),
        maxLength: 256,
        help: t("channels.nostrForm.displayNameHelp"),
      })}

      ${renderField("about", t("channels.nostrForm.bio"), {
        type: "textarea",
        placeholder: t("channels.nostrForm.bioPlaceholder"),
        maxLength: 2000,
        help: t("channels.nostrForm.bioHelp"),
      })}

      ${renderField("picture", t("channels.nostrForm.avatarUrl"), {
        type: "url",
        placeholder: t("channels.nostrForm.avatarUrlPlaceholder"),
        help: t("channels.nostrForm.avatarUrlHelp"),
      })}
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">${t("channels.nostrForm.advanced")}</div>

              ${renderField("banner", t("channels.nostrForm.bannerUrl"), {
                type: "url",
                placeholder: t("channels.nostrForm.bannerUrlPlaceholder"),
                help: t("channels.nostrForm.bannerUrlHelp"),
              })}

              ${renderField("website", t("channels.nostrForm.website"), {
                type: "url",
                placeholder: t("channels.nostrForm.websitePlaceholder"),
                help: t("channels.nostrForm.websiteHelp"),
              })}

              ${renderField("nip05", t("channels.nostrForm.nip05"), {
                placeholder: t("channels.nostrForm.nip05Placeholder"),
                help: t("channels.nostrForm.nip05Help"),
              })}

              ${renderField("lud16", t("channels.nostrForm.lightningAddress"), {
                placeholder: t("channels.nostrForm.lightningAddressPlaceholder"),
                help: t("channels.nostrForm.lightningAddressHelp"),
              })}
            </div>
          `
          : nothing
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("channels.nostrForm.saving") : t("channels.nostrForm.saveAndPublish")}
        </button>
        ...
        >
          ${state.importing ? t("channels.nostrForm.importing") : t("channels.nostrForm.importFromRelays")}
        </button>
        ...
        >
          ${state.showAdvanced ? t("channels.nostrForm.hideAdvanced") : t("channels.nostrForm.showAdvanced")}
        </button>
        ...
        isDirty
          ? html`
              <div style="font-size: 12px; color: var(--warning-color); margin-top: 8px">
                ${t("channels.nostrForm.unsavedChanges")}
              </div>
            `
          : nothing
      }
