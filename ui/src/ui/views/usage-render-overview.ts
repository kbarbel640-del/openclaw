...
function renderFilterChips(
  ...
  const sessionsLabel = selectedSession
    ...
    : selectedSessions.length === 1
      ...
      : t("usageUi.filters.selectedSessionsCount", { count: String(selectedSessions.length) });
  ...
  const daysLabel =
    selectedDays.length === 1
      ? selectedDays[0]
      : t("usageUi.filters.selectedDaysCount", { count: String(selectedDays.length) });
  const hoursLabel =
    selectedHours.length === 1
      ? `${selectedHours[0]}:00`
      : t("usageUi.filters.selectedHoursCount", { count: String(selectedHours.length) });
    ...
    <div class="active-filters">
        ...
        selectedDays.length > 0
          ? html`
            <div class="filter-chip">
              <span class="filter-chip-label">${t("usageUi.filters.days")}: ${daysLabel}</span>
              <button
                class="filter-chip-remove"
                @click=${onClearDays}
                title=${t("usageUi.filters.removeFilter")}
              >
                ×
              </button>
            </div>
      ...
      ${
        selectedHours.length > 0
          ? html`
            <div class="filter-chip">
              <span class="filter-chip-label">${t("usageUi.filters.hours")}: ${hoursLabel}</span>
              <button
                class="filter-chip-remove"
                @click=${onClearHours}
                title=${t("usageUi.filters.removeFilter")}
          ...
          ? html`
            <div class="filter-chip" title="${sessionsFullName}">
              <span class="filter-chip-label">
                ${t("usageUi.filters.session")}: ${sessionsLabel}
              </span>
              <button
                class="filter-chip-remove"
...
function renderDailyChartCompact(
  ...
  if (!daily.length) {
    return html`
        ...
        <div class="sessions-panel-title">${t("usageUi.daily.title")}</div>
        <div class="muted" style="padding: 20px; text-align: center">
          ${t("usageUi.daily.noData")}
        </div>
      </div>
    `;
  }
    ...
    <div class="daily-chart-compact">
      <div class="daily-chart-header">
        ...
        <div class="card-title">
          ${isTokenMode ? t("usageUi.daily.tokenUsage") : t("usageUi.daily.costUsage")}
        </div>
      </div>
          ...
          ${daily.map((d, idx) => {
            ...
            const breakdownLines =
              dailyChartMode === "by-type"
                ? isTokenMode
                  ? [
                      t("usageUi.breakdown.outputValue", { value: formatTokens(d.output) }),
                      t("usageUi.breakdown.inputValue", { value: formatTokens(d.input) }),
                      t("usageUi.breakdown.cacheWriteValue", {
                        value: formatTokens(d.cacheWrite),
                      }),
                      t("usageUi.breakdown.cacheReadValue", {
                        value: formatTokens(d.cacheRead),
                      }),
                    ]
                  : [
                      t("usageUi.breakdown.outputValue", { value: formatCost(d.outputCost ?? 0) }),
                      t("usageUi.breakdown.inputValue", { value: formatCost(d.inputCost ?? 0) }),
                      t("usageUi.breakdown.cacheWriteValue", {
            ...
            return html`
              ...
              >
                ...
                <div class="daily-bar-tooltip">
                  ...
                  ${t("usageUi.labels.tokensValue", { value: formatTokens(d.totalTokens) })}<br />
  ...
  return html`
    <div class="cost-breakdown cost-breakdown-compact">
      <div class="cost-breakdown-header">
        ${isTokenMode ? t("usageUi.breakdown.tokensByType") : t("usageUi.breakdown.costByType")}
      </div>
      <div class="cost-breakdown-bar">
        <div class="cost-segment output" style="width: ${(isTokenMode ? tokenPcts.output : breakdown.output.pct).toFixed(1)}%"
          title=${t("usageUi.breakdown.outputValue", {
        ...
        <div class="cost-segment input" style="width: ${(isTokenMode ? tokenPcts.input : breakdown.input.pct).toFixed(1)}%"
          title=${t("usageUi.breakdown.inputValue", {
        ...
        <div class="cost-segment cache-write" style="width: ${(isTokenMode ? tokenPcts.cacheWrite : breakdown.cacheWrite.pct).toFixed(1)}%"
          title=${t("usageUi.breakdown.cacheWriteValue", {
            value: isTokenMode
        ...
        <div class="cost-segment cache-read" style="width: ${(isTokenMode ? tokenPcts.cacheRead : breakdown.cacheRead.pct).toFixed(1)}%"
          title=${t("usageUi.breakdown.cacheReadValue", {
            value: isTokenMode
      ...
      <div class="cost-breakdown-legend">
        <span class="legend-item">
          <span class="legend-dot output"></span>${t("usageUi.breakdown.outputValue", {
            value: isTokenMode ? formatTokens(totals.output) : formatCost(breakdown.output.cost),
          })}
        </span>
        <span class="legend-item">
          <span class="legend-dot input"></span>${t("usageUi.breakdown.inputValue", {
            value: isTokenMode ? formatTokens(totals.input) : formatCost(breakdown.input.cost),
          })}
        </span>
        <span class="legend-item">
          <span class="legend-dot cache-write"></span>${t("usageUi.breakdown.cacheWriteValue", {
            value: isTokenMode
              ? formatTokens(totals.cacheWrite)
              : formatCost(breakdown.cacheWrite.cost),
          })}
        ...
        <span class="legend-item">
          <span class="legend-dot cache-read"></span>${t("usageUi.breakdown.cacheReadValue", {
            value: isTokenMode
              ? formatTokens(totals.cacheRead)
              : formatCost(breakdown.cacheRead.cost),
          })}
      ...
      <div class="cost-breakdown-total">
        ${t("usageUi.breakdown.totalValue", {
          value: isTokenMode ? formatTokens(totals.totalTokens) : formatCost(totals.totalCost),
        })}
      </div>
    </div>
  `;
...
function renderUsageInsights(
  ...
  const throughputLabel =
    stats.throughputTokensPerMin !== undefined
      ? t("usageUi.insights.throughputTokensPerMin", {
          value: formatTokens(Math.round(stats.throughputTokensPerMin)),
        })
      : "—";
  const throughputCostLabel =
    stats.throughputCostPerMin !== undefined
      ? t("usageUi.insights.throughputCostPerMin", {
          value: formatCost(stats.throughputCostPerMin, 4),
        })
      : "—";
  const avgDurationLabel =
    stats.durationCount > 0
      ...
      : "—";
  const cacheHint = t("usageUi.insights.hints.cacheHitRate");
  const errorHint = t("usageUi.insights.hints.errorRate");
  const throughputHint = t("usageUi.insights.hints.throughput");
  const tokensHint = t("usageUi.insights.hints.avgTokens");
  const costHint = showCostHint
    ? t("usageUi.insights.hints.avgCostMissing")
    : t("usageUi.insights.hints.avgCost");
  ...
  const errorDays = aggregates.daily
    ...
    .map((day) => {
      ...
      return {
        ...
        sub: t("usageUi.insights.errorDaySub", {
  ...
  return html`
    <section class="card" style="margin-top: 16px;">
      <div class="card-title">${t("usageUi.insights.title")}</div>
      <div class="usage-summary-grid">
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.messages.title")}
            <span class="usage-summary-hint" title=${t("usageUi.insights.cards.messages.hint")}>?</span>
          </div>
          <div class="usage-summary-value">${aggregates.messages.total}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.messages.sub", {
              user: String(aggregates.messages.user),
              assistant: String(aggregates.messages.assistant),
            })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.toolCalls.title")}
            <span class="usage-summary-hint" title=${t("usageUi.insights.cards.toolCalls.hint")}>?</span>
          </div>
          <div class="usage-summary-value">${aggregates.tools.totalCalls}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.toolCalls.sub", {
              count: String(aggregates.tools.uniqueTools),
            })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.errors.title")}
            <span class="usage-summary-hint" title=${t("usageUi.insights.cards.errors.hint")}>?</span>
          </div>
          <div class="usage-summary-value">${aggregates.messages.errors}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.errors.sub", {
              count: String(aggregates.messages.toolResults),
            })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.avgTokens.title")}
            <span class="usage-summary-hint" title=${tokensHint}>?</span>
          </div>
          <div class="usage-summary-value">${formatTokens(avgTokens)}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.avgTokens.sub", {
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.avgCost.title")}
            <span class="usage-summary-hint" title=${costHint}>?</span>
          </div>
          <div class="usage-summary-value">${formatCost(avgCost, 4)}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.avgCost.sub", { value: formatCost(totals.totalCost) })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.sessions.title")}
            <span class="usage-summary-hint" title=${t("usageUi.insights.cards.sessions.hint")}>?</span>
          </div>
          <div class="usage-summary-value">${sessionCount}</div>
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.sessions.sub", { total: String(totalSessions) })}
          </div>
        </div>
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.throughput.title")}
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.errorRate.title")}
          ...
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.errorRate.sub", {
              errors: String(aggregates.messages.errors),
        ...
        <div class="usage-summary-card">
          <div class="usage-summary-title">
            ${t("usageUi.insights.cards.cacheHitRate.title")}
          ...
          <div class="usage-summary-sub">
            ${t("usageUi.insights.cards.cacheHitRate.sub", {
              cached: formatTokens(totals.cacheRead),
              prompt: formatTokens(cacheBase),
            })}
          </div>
        </div>
      </div>
      <div class="usage-insights-grid">
        ${renderInsightList(
          t("usageUi.insights.lists.topModels"),
          topModels,
          t("usageUi.insights.empty.noModelData"),
        )}
        ${renderInsightList(
          t("usageUi.insights.lists.topProviders"),
          topProviders,
          t("usageUi.insights.empty.noProviderData"),
        )}
        ${renderInsightList(
        ...
        ${renderInsightList(
          t("usageUi.insights.lists.topAgents"),
          topAgents,
          t("usageUi.insights.empty.noAgentData"),
        )}
        ${renderInsightList(
          t("usageUi.insights.lists.topChannels"),
          topChannels,
          t("usageUi.insights.empty.noChannelData"),
        )}
        ${renderPeakErrorList(
          t("usageUi.insights.lists.peakErrorDays"),
          errorDays,
          t("usageUi.insights.empty.noErrorData"),
        )}
        ${renderPeakErrorList(
          t("usageUi.insights.lists.peakErrorHours"),
          errorHours,
          t("usageUi.insights.empty.noErrorData"),
        )}
      </div>
      ...
      >
        ...
        <div class="session-bar-actions">
          <button
            ...
            title=${t("usageUi.sessions.copyName")}
            @click=${(e: MouseEvent) => {
              e.stopPropagation();
              void copySessionName(s);
            }}
          >
            ${t("usageUi.sessions.copy")}
          </button>
  ...
  return html`
    <div class="card sessions-card">
      <div class="sessions-card-header">
        <div class="card-title">${t("usageUi.sessions.title")}</div>
        <div class="sessions-card-count">
          ${t("usageUi.sessions.shownCount", {
      ...
      <div class="sessions-card-meta">
        <div class="sessions-card-stats">
          <span>
            ${t("usageUi.sessions.avgValue", {
              value: isTokenMode ? formatTokens(avgValue) : formatCost(avgValue),
            })}
          </span>
          <span>${t("usageUi.sessions.errorsValue", { count: String(totalErrors) })}</span>
        </div>
        <div class="chart-toggle small">
          ...
          >
            ${t("usageUi.sessions.tabs.recent")}
          </button>
        </div>
        <label class="sessions-sort">
          ...
          >
            <option value="cost" ?selected=${sessionSort === "cost"}>${t("usageUi.sort.cost")}</option>
            <option value="errors" ?selected=${sessionSort === "errors"}>${t("usageUi.sort.errors")}</option>
            <option value="messages" ?selected=${sessionSort === "messages"}>${t("usageUi.sort.messages")}</option>
            <option value="recent" ?selected=${sessionSort === "recent"}>${t("usageUi.sort.recent")}</option>
            <option value="tokens" ?selected=${sessionSort === "tokens"}>${t("usageUi.sort.tokens")}</option>
          </select>
        </label>
        <button
          class="btn btn-sm sessions-action-btn icon"
          @click=${() => onSessionSortDirChange(sessionSortDir === "desc" ? "asc" : "desc")}
          title=${sessionSortDir === "desc" ? t("usageUi.sort.descending") : t("usageUi.sort.ascending")}
        >
          ${sessionSortDir === "desc" ? "↓" : "↑"}
        </button>
        ${
          selectedCount > 0
            ? html`
                <button class="btn btn-sm sessions-action-btn sessions-clear-btn" @click=${onClearSessions}>
                  ${t("usageUi.sessions.clearSelection")}
                </button>
              `
            : nothing
        }
      ...
      ${
        sessionsTab === "recent"
          ...
          : sessions.length === 0
            ? html`
                <div class="muted" style="padding: 20px; text-align: center">
                  ${t("usageUi.sessions.noSessionsInRange")}
                </div>
              `
            : html`
	                <div class="session-bars">
	                  ...
	                  ${
                      sessions.length > 50
                        ? html`<div class="muted" style="padding: 8px; text-align: center; font-size: 11px;">
                            ${t("usageUi.sessions.moreCount", {
                              count: String(sessions.length - 50),
                            })}
                          </div>`
                        : nothing
                    }
        ...
        selectedCount > 1
          ? html`
              <div style="margin-top: 10px;">
                <div class="sessions-card-count">
                  ${t("usageUi.sessions.selectedCount", { count: String(selectedCount) })}
                </div>
