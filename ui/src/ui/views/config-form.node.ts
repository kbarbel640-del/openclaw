...
export function renderNode(params: {
  ...
  if (unsupported.has(key)) {
    return html`<div class="cfg-field cfg-field--error">
      ...
      <div class="cfg-field__error">${t("configFormUi.unsupportedNode")}</div>
    </div>`;
  }
  if (
    criteria &&
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">${t("configFormUi.unsupportedType", { type })}</div>
    </div>
  `;
}
  ...
  const placeholder =
    ...
    (isSensitive
      ...
      : schema.default !== undefined
        ? t("configFormUi.defaultValue", { value: String(schema.default) })
        : "");
      ...
      <div class="cfg-input-wrap">
        ...
        ${
          ...
          <button
            ...
            title=${t("configFormUi.resetToDefault")}
            ?disabled=${disabled}
...
function renderSelect(params: {
  ...
  return html`
    <div class="cfg-field">
      ...
      >
        <option value=${unset}>${t("configFormUi.selectPlaceholder")}</option>
        ${options.map(
          (opt, idx) => html`
...
function renderArray(params: {
  ...
  if (!itemsSchema) {
    return html`
      <div class="cfg-field cfg-field--error">
        <div class="cfg-field__label">${label}</div>
        <div class="cfg-field__error">${t("configFormUi.unsupportedArraySchema")}</div>
      </div>
    `;
  }
  ...
  return html`
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <span class="cfg-array__count">${t("configFormUi.arrayItemsCount", { count: String(arr.length) })}</span>
        <button
          type="button"
      ...
      ${
        arr.length === 0
          ? html`
              <div class="cfg-array__empty">${t("configFormUi.arrayEmpty")}</div>
            `
          : html`
            ...
            <div class="cfg-array__item">
              <div class="cfg-array__item-header">
                ...
                <button
                  ...
                  title=${t("configFormUi.removeItem")}
                  ?disabled=${disabled}
                  @click=${() => {
                    const next = [...arr];
                    next.splice(idx, 1);
  ...
  return html`
    <div class="cfg-map">
      <div class="cfg-map__header">
        <span class="cfg-map__label">${t("configFormUi.customEntries")}</span>
        <button
          type="button"
          class="cfg-map__add"
          ?disabled=${disabled}
      ...
      ${
        visibleEntries.length === 0
          ? html`
              <div class="cfg-map__empty">${t("configFormUi.noCustomEntries")}</div>
            `
          : html`
                ...
                <div class="cfg-map__item-header">
                  <div class="cfg-map__item-key">
                    <input
                      ...
                      placeholder=${t("configFormUi.key")}
                      .value=${key}
                      ?disabled=${disabled}
                      @change=${(e: Event) => {
                  ...
                  <button
                    ...
                    title=${t("configFormUi.removeEntry")}
                    ?disabled=${disabled}
                    @click=${() => {
                      const next = { ...value };
                      delete next[key];
                    ...
                    anySchema
                      ? html`
                        <textarea
                          ...
                          placeholder=${t("configFormUi.jsonValue")}
                          rows="2"
                          .value=${fallback}
                          ?disabled=${disabled}
                          @change=${(e: Event) => {
