...
export const en_base: TranslationMap = {
  common: {
    version: "Version",
    health: "Health",
    ok: "OK",
  ...
  overview: {
    ...
    docs: {
      pairingLinkTitle: "Device pairing docs (opens in new tab)",
      pairingLinkLabel: "Docs: Device pairing",
      authLinkTitle: "Control UI auth docs (opens in new tab)",
      authLinkLabel: "Docs: Control UI auth",
      tailscaleLinkTitle: "Tailscale Serve docs (opens in new tab)",
      tailscaleLinkLabel: "Docs: Tailscale Serve",
      insecureHttpLinkTitle: "Insecure HTTP docs (opens in new tab)",
      insecureHttpLinkLabel: "Docs: Insecure HTTP",
    },
  },
  chat: {
