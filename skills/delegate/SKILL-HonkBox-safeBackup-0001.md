...
Path:
`~/Shared/skills/delegate/scripts/copilot-delegate.mjs`
...
```bash
ssh maxblack
node ~/Shared/skills/delegate/scripts/copilot-delegate.mjs --prompt "<task>"
```
...
```bash
node ~/Shared/skills/delegate/scripts/copilot-delegate.mjs \
...
```bash
node ~/Shared/skills/delegate/scripts/copilot-delegate.mjs --list-models
```

Stream live tokens while it runs:

```bash
node ~/Shared/skills/delegate/scripts/copilot-delegate.mjs --stream --prompt "<task>"
```
