---
name: growth-marketing-roadmap-prioritization
description: Automate roadmap prioritization workflows for Growth Marketing. Use when owners need reliable execution for Growth Marketing priorities and measurable KPI outcomes.
---

# Growth Marketing Roadmap Prioritization

## Mission

Prioritize work in growth loops and demand generation with clear cost-impact tradeoffs.

## Trigger Signals

- Backlog grows beyond delivery capacity in Growth Marketing.
...
- Prioritized roadmap with rationale and cut lines.
- Concise status summary with owner, due date, and risk flags.
- Next best actions ranked by expected impact.

## KPI Contract

- High-priority delivery rate and cycle-time stability.
...
- Prompt seed: Act as a top-tier growth marketer and execute Roadmap Prioritization for Growth Marketing.
