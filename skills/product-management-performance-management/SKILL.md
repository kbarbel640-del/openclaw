---
name: product-management-performance-management
description: Automate performance management workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Performance Management

## Mission

Operationalize performance reviews for product planning and execution.

## Trigger Signals

- Review cycles begin in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Performance Management for Product Management.
