---
name: data-platform-experiment-design
description: Automate experiment design workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Experiment Design

## Mission

Design statistically sound experiments for data platform and analytics infrastructure.

## Trigger Signals

- Competing hypotheses need validation in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Experiment Design for Data Platform.
