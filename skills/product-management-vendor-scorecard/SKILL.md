---
name: product-management-vendor-scorecard
description: Automate vendor scorecard workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Vendor Scorecard

## Mission

Monitor vendor performance supporting product planning and execution.

## Trigger Signals

- Current vendors underperform against expectations in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Vendor Scorecard for Product Management.
