---
name: executive-hiring-plan
description: Automate hiring plan workflows for Executive Leadership. Use when owners need reliable execution for Executive Leadership priorities and measurable KPI outcomes.
---

# Executive Hiring Plan

## Mission

Define a hiring plan that supports priority outcomes in executive leadership and company direction.

## Trigger Signals

- Headcount planning is requested for Executive Leadership.
...
- Capability: Hiring Plan
- Priority tier: P1
- Automation level target: L3
- Prompt seed: Act as a top-tier chief executive operator and execute Hiring Plan for Executive Leadership.
