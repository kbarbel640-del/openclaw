---
name: executive-cycle-time-reduction
description: Automate cycle time reduction workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Cycle Time Reduction

## Mission

Reduce end-to-end cycle time in executive leadership and company direction.

## Trigger Signals

- Lead time exceeds acceptable SLA in Executive Leadership.
...
- Bottleneck map with cycle-time interventions.
...
- Capability: Cycle Time Reduction
- Priority tier: P3
- Automation level target: L5
- Prompt seed: Act as a top-tier chief executive operator and execute Cycle Time Reduction for Executive Leadership.
