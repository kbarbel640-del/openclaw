---
name: sales-hiring-plan
description: Automate hiring plan workflows for Sales. Use when owners need reliable execution for Sales priorities and measurable KPI outcomes.
---
...
Define a hiring plan that supports priority outcomes in pipeline creation and revenue closing.

## Trigger Signals

- Headcount planning is requested for Sales.
...
- Prompt seed: Act as a top-tier sales operator and execute Hiring Plan for Sales.
