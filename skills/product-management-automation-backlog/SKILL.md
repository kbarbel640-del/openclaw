---
name: product-management-automation-backlog
description: Automate automation backlog workflows for Product Management. Use when owners need reliable execution for Product Management priorities and measurable KPI outcomes.
---

# Product Management Automation Backlog

## Mission

Build an automation backlog ranked by impact in product planning and execution.

## Trigger Signals

- The team asks what to automate next in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Automation Backlog for Product Management.
