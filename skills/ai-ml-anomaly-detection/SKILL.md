...
description: Automate anomaly detection workflows for AI and ML. Use when operators need dependable execution for AI and ML work with measurable KPI outcomes.
---
...
Monitor metrics and detect anomalies in applied AI and ML systems.

## Trigger Signals

- Unexpected swings are observed in AI and ML KPIs.
...
- Prompt seed: Act as a top-tier AI lead and execute Anomaly Detection for AI and ML.
