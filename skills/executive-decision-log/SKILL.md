...
description: Automate decision log workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---
...
Maintain a transparent decision log for executive leadership and company direction.

## Trigger Signals

- Decision context is repeatedly lost in Executive Leadership.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Decision Log for Executive Leadership.
