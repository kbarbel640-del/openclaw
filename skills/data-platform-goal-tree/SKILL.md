---
name: data-platform-goal-tree
description: Automate goal tree workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Goal Tree

## Mission

Translate company goals into a measurable goal tree for data platform and analytics infrastructure.

## Trigger Signals

- Leadership asks for clearer KPI alignment in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Goal Tree for Data Platform.
