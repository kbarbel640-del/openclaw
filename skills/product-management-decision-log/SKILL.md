---
name: product-management-decision-log
description: Automate decision log workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Decision Log

## Mission

Maintain a transparent decision log for product planning and execution.

## Trigger Signals

- Decision context is repeatedly lost in Product Management.
...
- Decision log with date, context, owner, and rationale.
...
- Prompt seed: Act as a top-tier product leader and execute Decision Log for Product Management.
