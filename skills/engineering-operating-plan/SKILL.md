---
name: engineering-operating-plan
description: Automate operating plan workflows for Engineering. Use when owners need reliable execution for Engineering priorities and measurable KPI outcomes.
---

# Engineering Operating Plan

## Mission

Create a 90-day operating plan for software engineering delivery.

## Trigger Signals

- A team needs a quarter execution plan in Engineering.
...
- Domain: Engineering
- Capability: Operating Plan
- Priority tier: P1
- Automation level target: L3
- Prompt seed: Act as a top-tier engineering leader and execute Operating Plan for Engineering.
