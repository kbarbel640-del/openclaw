...
description: Automate incident response workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---
...
Run incident triage and response workflows for software engineering delivery.

## Trigger Signals

- A service or process incident hits Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Incident Response for Engineering.
