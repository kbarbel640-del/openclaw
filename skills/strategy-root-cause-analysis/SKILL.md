---
name: strategy-root-cause-analysis
description: Automate root cause analysis workflows for Corporate Strategy. Use when operators need dependable execution for Corporate Strategy work with measurable KPI outcomes.
---
...
Run root-cause analysis for repeat failures in corporate strategy and market positioning.

## Trigger Signals

- The same issue repeats in Corporate Strategy.
...
- Prompt seed: Act as a top-tier strategy leader and execute Root Cause Analysis for Corporate Strategy.
