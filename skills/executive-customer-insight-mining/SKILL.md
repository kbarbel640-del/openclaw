---
name: executive-customer-insight-mining
description: Automate customer insight mining workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Customer Insight Mining

## Mission

Mine customer signals and extract priorities for executive leadership and company direction.

## Trigger Signals

- Signal volume from customers exceeds manual review in Executive Leadership.
...
- Insight brief with ranked customer themes.
...
- Capability: Customer Insight Mining
- Priority tier: P2
- Automation level target: L4
- Prompt seed: Act as a top-tier chief executive operator and execute Customer Insight Mining for Executive Leadership.
