---
name: product-management-experiment-design
description: Automate experiment design workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---
...
Design statistically sound experiments for product planning and execution.

## Trigger Signals

- Competing hypotheses need validation in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Experiment Design for Product Management.
