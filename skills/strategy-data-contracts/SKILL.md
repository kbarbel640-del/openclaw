---
name: strategy-data-contracts
description: Automate data contracts workflows for Corporate Strategy. Use when operators need dependable execution for Corporate Strategy work with measurable KPI outcomes.
---
...
Define enforceable data contracts used by corporate strategy and market positioning.

## Trigger Signals

- Upstream data changes repeatedly break workflows in Corporate Strategy.
...
- Prompt seed: Act as a top-tier strategy leader and execute Data Contracts for Corporate Strategy.
