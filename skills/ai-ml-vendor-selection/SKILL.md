---
name: ai-ml-vendor-selection
description: Automate vendor selection workflows for AI and ML. Use when operators need dependable execution for AI and ML work with measurable KPI outcomes.
---

# Ai Ml Vendor Selection

## Mission

Run a structured vendor selection process for applied AI and ML systems.

## Trigger Signals

- A new tool or service is needed in AI and ML.
...
- Prompt seed: Act as a top-tier AI lead and execute Vendor Selection for AI and ML.
