---
name: product-management-continuous-improvement-loop
description: Automate continuous improvement loop workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Continuous Improvement Loop

## Mission

Run a continuous improvement loop for product planning and execution.

## Trigger Signals

- The team wants systematic optimization in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Continuous Improvement Loop for Product Management.
