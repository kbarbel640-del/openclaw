---
name: executive-budget-allocator
description: Automate budget allocator workflows for Executive Leadership. Use when owners need reliable execution for Executive Leadership priorities and measurable KPI outcomes.
---

# Executive Budget Allocator

## Mission

Allocate budget across initiatives in executive leadership and company direction using expected impact.

## Trigger Signals

- Budget planning or reforecast is requested for Executive Leadership.
...
- Capability: Budget Allocator
- Priority tier: P1
- Automation level target: L3
- Prompt seed: Act as a top-tier chief executive operator and execute Budget Allocator for Executive Leadership.
