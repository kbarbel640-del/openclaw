---
name: executive-vendor-scorecard
description: Automate vendor scorecard workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Vendor Scorecard

## Mission

Monitor vendor performance supporting executive leadership and company direction.

## Trigger Signals

- Current vendors underperform against expectations in Executive Leadership.
...
- Vendor scorecard with SLA and risk trend.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Vendor Scorecard for Executive Leadership.
