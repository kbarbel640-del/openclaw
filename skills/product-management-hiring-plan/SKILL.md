---
name: product-management-hiring-plan
description: Automate hiring plan workflows for Product Management. Use when owners need reliable execution for Product Management priorities and measurable KPI outcomes.
---

# Product Management Hiring Plan

## Mission

Define a hiring plan that supports priority outcomes in product planning and execution.

## Trigger Signals

- Headcount planning is requested for Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Hiring Plan for Product Management.
