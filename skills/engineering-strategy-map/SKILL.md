---
name: engineering-strategy-map
description: Automate strategy map workflows for Engineering. Use when owners need reliable execution for Engineering priorities and measurable KPI outcomes.
---

# Engineering Strategy Map

## Mission

Build and maintain a quarterly strategy map for software engineering delivery.

## Trigger Signals

- A new planning cycle starts in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Strategy Map for Engineering.
