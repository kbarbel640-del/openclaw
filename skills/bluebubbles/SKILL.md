---
name: bluebubbles
description: Use when you need to build, update, or debug the BlueBubbles external channel plugin for Clawdbot (extension package, REST send/probe, webhook inbound).
metadata:
  openclaw:
    emoji: 🟦
    requires: {}
