---
name: coding-agent
description: Use when you need to run Codex CLI, Claude Code, OpenCode, or Pi Coding Agent in the background for programmatic code generation, review, or refactoring tasks.
metadata:
  openclaw:
    emoji: 🧩
    requires:
