---
name: ai-ml-data-contracts
description: Automate data contracts workflows for AI and ML. Use when operators need dependable execution for AI and ML work with measurable KPI outcomes.
---
...
Define enforceable data contracts used by applied AI and ML systems.

## Trigger Signals

- Upstream data changes repeatedly break workflows in AI and ML.
...
- Prompt seed: Act as a top-tier AI lead and execute Data Contracts for AI and ML.
