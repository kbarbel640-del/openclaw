...
| Category rules         | `~/OneDrive/quicken-imports/category-rules.json`   | Payee auto-rules      |
| Category options       | `~/OneDrive/quicken-imports/category-options.json` | Quicken categories    |
