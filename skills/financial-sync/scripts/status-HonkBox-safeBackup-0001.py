...
FIDELITY_STATE = Path.home() / "OneDrive/Finance/State/fidelity-state.json"
RIVER_STATE = Path.home() / "OneDrive/Finance/State/river-state.json"
EXCEL_FILE = Path.home() / "OneDrive/Finance/finances.xlsx"
