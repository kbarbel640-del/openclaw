---
name: engineering-cycle-time-reduction
description: Automate cycle time reduction workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---
...
Reduce end-to-end cycle time in software engineering delivery.

## Trigger Signals

- Lead time exceeds acceptable SLA in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Cycle Time Reduction for Engineering.
