---
name: data-platform-customer-insight-mining
description: Automate customer insight mining workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Customer Insight Mining

## Mission

Mine customer signals and extract priorities for data platform and analytics infrastructure.

## Trigger Signals

- Signal volume from customers exceeds manual review in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Customer Insight Mining for Data Platform.
