---
name: engineering-customer-insight-mining
description: Automate customer insight mining workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---

# Engineering Customer Insight Mining

## Mission

Mine customer signals and extract priorities for software engineering delivery.

## Trigger Signals

- Signal volume from customers exceeds manual review in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Customer Insight Mining for Engineering.
