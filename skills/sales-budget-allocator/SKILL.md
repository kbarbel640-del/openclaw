---
name: sales-budget-allocator
description: Automate budget allocator workflows for Sales. Use when owners need reliable execution for Sales priorities and measurable KPI outcomes.
---

# Sales Budget Allocator

## Mission

Allocate budget across initiatives in pipeline creation and revenue closing using expected impact.

## Trigger Signals

- Budget planning or reforecast is requested for Sales.
...
- Prompt seed: Act as a top-tier sales operator and execute Budget Allocator for Sales.
