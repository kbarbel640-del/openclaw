---
name: data-platform-ai-ops-monitoring
description: Automate ai ops monitoring workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Ai Ops Monitoring

## Mission

Monitor AI workflow quality and drift in data platform and analytics infrastructure.

## Trigger Signals

- Agent performance becomes unstable in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute AI Ops Monitoring for Data Platform.
