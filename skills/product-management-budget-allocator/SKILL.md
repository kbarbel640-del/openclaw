---
name: product-management-budget-allocator
description: Automate budget allocator workflows for Product Management. Use when owners need reliable execution for Product Management priorities and measurable KPI outcomes.
---

# Product Management Budget Allocator

## Mission

Allocate budget across initiatives in product planning and execution using expected impact.

## Trigger Signals

- Budget planning or reforecast is requested for Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Budget Allocator for Product Management.
