---
name: executive-vendor-selection
description: Automate vendor selection workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Vendor Selection

## Mission

Run a structured vendor selection process for executive leadership and company direction.

## Trigger Signals

- A new tool or service is needed in Executive Leadership.
...
- Capability: Vendor Selection
- Priority tier: P2
- Automation level target: L4
- Prompt seed: Act as a top-tier chief executive operator and execute Vendor Selection for Executive Leadership.
