---
name: executive-scenario-planning
description: Automate scenario planning workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---
...
Model best/base/worst scenarios for executive leadership and company direction.

## Trigger Signals

- A major decision requires downside analysis in Executive Leadership.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Scenario Planning for Executive Leadership.
