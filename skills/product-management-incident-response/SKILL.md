---
name: product-management-incident-response
description: Automate incident response workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Incident Response

## Mission

Run incident triage and response workflows for product planning and execution.

## Trigger Signals

- A service or process incident hits Product Management.
...
- Incident timeline, owner matrix, and resolution plan.
...
- Prompt seed: Act as a top-tier product leader and execute Incident Response for Product Management.
