---
name: data-platform-workflow-design
description: Automate workflow design workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Workflow Design

## Mission

Design a standard workflow for repeatable work in data platform and analytics infrastructure.

## Trigger Signals

- Manual handoffs cause delays in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Workflow Design for Data Platform.
