---
name: data-platform-risk-register
description: Automate risk register workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Risk Register

## Mission

Maintain a live risk register for data platform and analytics infrastructure.

## Trigger Signals

- New dependencies or threats emerge in Data Platform.
...
- Open high-risk items older than SLA.
...
- Prompt seed: Act as a top-tier data platform lead and execute Risk Register for Data Platform.
