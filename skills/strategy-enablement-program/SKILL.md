---
name: strategy-enablement-program
description: Automate enablement program workflows for Corporate Strategy. Use when operators need dependable execution for Corporate Strategy work with measurable KPI outcomes.
---

# Strategy Enablement Program

## Mission

Create a repeatable enablement program for corporate strategy and market positioning.

## Trigger Signals

- New team members ramp slowly in Corporate Strategy.
...
- Enablement curriculum with milestones.
...
- Capability: Enablement Program
- Priority tier: P3
- Automation level target: L5
- Prompt seed: Act as a top-tier strategy leader and execute Enablement Program for Corporate Strategy.
