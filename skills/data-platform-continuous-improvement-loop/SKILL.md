---
name: data-platform-continuous-improvement-loop
description: Automate continuous improvement loop workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Continuous Improvement Loop

## Mission

Run a continuous improvement loop for data platform and analytics infrastructure.

## Trigger Signals

- The team wants systematic optimization in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Continuous Improvement Loop for Data Platform.
