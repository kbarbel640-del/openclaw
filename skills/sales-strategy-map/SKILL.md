---
name: sales-strategy-map
description: Automate strategy map workflows for Sales. Use when owners need reliable execution for Sales priorities and measurable KPI outcomes.
---
...
Build and maintain a quarterly strategy map for pipeline creation and revenue closing.

## Trigger Signals

- A new planning cycle starts in Sales.
...
- Prompt seed: Act as a top-tier sales operator and execute Strategy Map for Sales.
