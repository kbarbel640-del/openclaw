---
name: product-management-anomaly-detection
description: Automate anomaly detection workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Anomaly Detection

## Mission

Monitor metrics and detect anomalies in product planning and execution.

## Trigger Signals

- Unexpected swings are observed in Product Management KPIs.
...
- Prompt seed: Act as a top-tier product leader and execute Anomaly Detection for Product Management.
