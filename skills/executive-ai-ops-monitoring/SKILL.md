---
name: executive-ai-ops-monitoring
description: Automate ai ops monitoring workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Ai Ops Monitoring

## Mission

Monitor AI workflow quality and drift in executive leadership and company direction.

## Trigger Signals

- Agent performance becomes unstable in Executive Leadership.
...
- AI operations dashboard with drift and failure alerts.
- Status summary with owner, due date, and risk flags.
- Prioritized next actions with expected impact.

## KPI Contract

- Automated workflow success rate with guardrails.
...
- Capability: AI Ops Monitoring
- Priority tier: P3
- Automation level target: L5
- Prompt seed: Act as a top-tier chief executive operator and execute AI Ops Monitoring for Executive Leadership.
