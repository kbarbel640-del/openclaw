---
name: engineering-vendor-scorecard
description: Automate vendor scorecard workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---

# Engineering Vendor Scorecard

## Mission

Monitor vendor performance supporting software engineering delivery.

## Trigger Signals

- Current vendors underperform against expectations in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Vendor Scorecard for Engineering.
