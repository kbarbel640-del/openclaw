---
name: product-management-kpi-dashboard
description: Automate kpi dashboard workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---
...
Build a live KPI dashboard for product planning and execution.

## Trigger Signals

- Leaders ask for real-time visibility in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute KPI Dashboard for Product Management.
