---
name: executive-incident-response
description: Automate incident response workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---
...
Run incident triage and response workflows for executive leadership and company direction.

## Trigger Signals

- A service or process incident hits Executive Leadership.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Incident Response for Executive Leadership.
