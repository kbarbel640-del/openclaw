---
name: executive-root-cause-analysis
description: Automate root cause analysis workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---
...
Run root-cause analysis for repeat failures in executive leadership and company direction.

## Trigger Signals

- The same issue repeats in Executive Leadership.
...
- RCA document with verified corrective actions.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Root Cause Analysis for Executive Leadership.
