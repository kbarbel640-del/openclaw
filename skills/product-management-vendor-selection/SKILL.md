---
name: product-management-vendor-selection
description: Automate vendor selection workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Vendor Selection

## Mission

Run a structured vendor selection process for product planning and execution.

## Trigger Signals

- A new tool or service is needed in Product Management.
...
- Prompt seed: Act as a top-tier product leader and execute Vendor Selection for Product Management.
