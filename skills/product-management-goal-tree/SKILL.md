---
name: product-management-goal-tree
description: Automate goal tree workflows for Product Management. Use when owners need reliable execution for Product Management priorities and measurable KPI outcomes.
---

# Product Management Goal Tree

## Mission

Translate company goals into a measurable goal tree for product planning and execution.

## Trigger Signals

- Leadership asks for clearer KPI alignment in Product Management.
...
- Capability: Goal Tree
- Priority tier: P1
- Automation level target: L3
- Prompt seed: Act as a top-tier product leader and execute Goal Tree for Product Management.
