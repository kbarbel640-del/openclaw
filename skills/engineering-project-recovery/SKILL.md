---
name: engineering-project-recovery
description: Automate project recovery workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---

# Engineering Project Recovery

## Mission

Detect and recover at-risk projects in software engineering delivery.

## Trigger Signals

- A project misses milestone targets in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Project Recovery for Engineering.
