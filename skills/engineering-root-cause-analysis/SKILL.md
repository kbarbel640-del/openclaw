---
name: engineering-root-cause-analysis
description: Automate root cause analysis workflows for Engineering. Use when operators need dependable execution for Engineering work with measurable KPI outcomes.
---
...
Run root-cause analysis for repeat failures in software engineering delivery.

## Trigger Signals

- The same issue repeats in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Root Cause Analysis for Engineering.
