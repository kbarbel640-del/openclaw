---
name: data-platform-decision-log
description: Automate decision log workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Decision Log

## Mission

Maintain a transparent decision log for data platform and analytics infrastructure.

## Trigger Signals

- Decision context is repeatedly lost in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Decision Log for Data Platform.
