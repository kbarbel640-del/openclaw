---
name: executive-automation-backlog
description: Automate automation backlog workflows for Executive Leadership. Use when owners need reliable execution for Executive Leadership priorities and measurable KPI outcomes.
---

# Executive Automation Backlog

## Mission

Build an automation backlog ranked by impact in executive leadership and company direction.

## Trigger Signals

- The team asks what to automate next in Executive Leadership.
...
- Capability: Automation Backlog
- Priority tier: P1
- Automation level target: L3
- Prompt seed: Act as a top-tier chief executive operator and execute Automation Backlog for Executive Leadership.
