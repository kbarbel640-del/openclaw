---
name: strategy-executive-memo
description: Automate executive memo workflows for Corporate Strategy. Use when operators need dependable execution for Corporate Strategy work with measurable KPI outcomes.
---

# Strategy Executive Memo

## Mission

Generate concise executive memos for corporate strategy and market positioning.

## Trigger Signals

- Leadership asks for fast context on a topic in Corporate Strategy.
...
- Decision memo with options and recommendation.
...
- Capability: Executive Memo
- Priority tier: P3
- Automation level target: L5
- Prompt seed: Act as a top-tier strategy leader and execute Executive Memo for Corporate Strategy.
