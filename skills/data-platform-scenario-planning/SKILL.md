---
name: data-platform-scenario-planning
description: Automate scenario planning workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Scenario Planning

## Mission

Model best/base/worst scenarios for data platform and analytics infrastructure.

## Trigger Signals

- A major decision requires downside analysis in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Scenario Planning for Data Platform.
