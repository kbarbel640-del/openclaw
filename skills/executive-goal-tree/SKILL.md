---
name: executive-goal-tree
description: Automate goal tree workflows for Executive Leadership. Use when owners need reliable execution for Executive Leadership priorities and measurable KPI outcomes.
---
...
Translate company goals into a measurable goal tree for executive leadership and company direction.

## Trigger Signals

- Leadership asks for clearer KPI alignment in Executive Leadership.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Goal Tree for Executive Leadership.
