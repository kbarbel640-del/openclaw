---
name: data-platform-project-recovery
description: Automate project recovery workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Project Recovery

## Mission

Detect and recover at-risk projects in data platform and analytics infrastructure.

## Trigger Signals

- A project misses milestone targets in Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Project Recovery for Data Platform.
