---
name: engineering-goal-tree
description: Automate goal tree workflows for Engineering. Use when owners need reliable execution for Engineering priorities and measurable KPI outcomes.
---

# Engineering Goal Tree

## Mission

Translate company goals into a measurable goal tree for software engineering delivery.

## Trigger Signals

- Leadership asks for clearer KPI alignment in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Goal Tree for Engineering.
