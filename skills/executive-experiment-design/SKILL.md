---
name: executive-experiment-design
description: Automate experiment design workflows for Executive Leadership. Use when operators need dependable execution for Executive Leadership work with measurable KPI outcomes.
---

# Executive Experiment Design

## Mission

Design statistically sound experiments for executive leadership and company direction.

## Trigger Signals

- Competing hypotheses need validation in Executive Leadership.
...
- Experiment protocol with success criteria.
...
- Prompt seed: Act as a top-tier chief executive operator and execute Experiment Design for Executive Leadership.
