---
name: product-management-data-contracts
description: Automate data contracts workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Data Contracts

## Mission

Define enforceable data contracts used by product planning and execution.

## Trigger Signals

- Upstream data changes repeatedly break workflows in Product Management.
...
- Data contract registry with schema and ownership.
...
- Prompt seed: Act as a top-tier product leader and execute Data Contracts for Product Management.
