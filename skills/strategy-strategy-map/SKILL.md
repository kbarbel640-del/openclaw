---
name: strategy-strategy-map
description: Automate strategy map workflows for Corporate Strategy. Use when operators need dependable execution for Corporate Strategy work with measurable KPI outcomes.
---
...
Build and maintain a quarterly strategy map for corporate strategy and market positioning.

## Trigger Signals

- A new planning cycle starts in Corporate Strategy.
...
- A ranked strategy map with owners, risks, and milestones.
- Status summary with owner, due date, and risk flags.
- Prioritized next actions with expected impact.

## KPI Contract

- Strategic initiative on-time completion rate.
...
- Prompt seed: Act as a top-tier strategy leader and execute Strategy Map for Corporate Strategy.
