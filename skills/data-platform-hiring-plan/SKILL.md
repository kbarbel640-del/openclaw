---
name: data-platform-hiring-plan
description: Automate hiring plan workflows for Data Platform. Use when operators need dependable execution for Data Platform work with measurable KPI outcomes.
---

# Data Platform Hiring Plan

## Mission

Define a hiring plan that supports priority outcomes in data platform and analytics infrastructure.

## Trigger Signals

- Headcount planning is requested for Data Platform.
...
- Prompt seed: Act as a top-tier data platform lead and execute Hiring Plan for Data Platform.
