---
name: product-management-project-recovery
description: Automate project recovery workflows for Product Management. Use when operators need dependable execution for Product Management work with measurable KPI outcomes.
---

# Product Management Project Recovery

## Mission

Detect and recover at-risk projects in product planning and execution.

## Trigger Signals

- A project misses milestone targets in Product Management.
...
- Capability: Project Recovery
- Priority tier: P3
- Automation level target: L5
- Prompt seed: Act as a top-tier product leader and execute Project Recovery for Product Management.
