---
name: engineering-automation-backlog
description: Automate automation backlog workflows for Engineering. Use when owners need reliable execution for Engineering priorities and measurable KPI outcomes.
---

# Engineering Automation Backlog

## Mission

Build an automation backlog ranked by impact in software engineering delivery.

## Trigger Signals

- The team asks what to automate next in Engineering.
...
- Prompt seed: Act as a top-tier engineering leader and execute Automation Backlog for Engineering.
