---
name: ai-ml-goal-tree
description: Automate goal tree workflows for AI and ML. Use when operators need dependable execution for AI and ML work with measurable KPI outcomes.
---
...
Translate company goals into a measurable goal tree for applied AI and ML systems.

## Trigger Signals

- Leadership asks for clearer KPI alignment in AI and ML.
...
- Prompt seed: Act as a top-tier AI lead and execute Goal Tree for AI and ML.
