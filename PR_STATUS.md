...
| --- | ----------------------------------------- | --------------------------------------------------------------------------- | -------- | --------------- | --------------------------------------------------------- |
| 12  | `fix/dmpolicy-allowlist-no-self-fallback` | fix(whatsapp): don't fallback to self phone in allowlist mode               | Bug fix  | Pending CI      | [#27000](https://github.com/openclaw/openclaw/pull/27000) |
