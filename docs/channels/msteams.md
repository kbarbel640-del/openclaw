...
moltbot message send --channel msteams --target "conversation:19:[redacted-email]2" --message "Hello"

# Send an Adaptive Card to a conversation
moltbot message send --channel msteams --target "conversation:19:[redacted-email]2" \
  --card '{"type":"AdaptiveCard","version":"1.5","body":[{"type":"TextBlock","text":"Hello"}]}'
```
