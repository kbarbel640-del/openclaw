...
1) Create a dedicated Apple ID (example: `[redacted-email]`).
...
- Use SSH keys so `ssh [redacted-email]` works without prompts.
...
- `chat_guid:...`
- `chat_identifier:...`
- direct handles: `imessage:+1555` / `sms:+1555` / `[redacted-email]`
