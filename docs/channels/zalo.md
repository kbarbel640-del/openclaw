...
- Install via CLI: `amigo plugins install @amigo/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `amigo plugins install ./extensions/zalo`
   - From npm (if published): `amigo plugins install @amigo/zalo`
...
- Approve via:
  - `amigo pairing list zalo`
  - `amigo pairing approve zalo <CODE>`
...
- Example: `amigo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `amigo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `amigo logs --follow`
