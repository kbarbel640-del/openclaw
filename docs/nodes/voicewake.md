...
Amigo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.amigo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["amigo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
