...
<Columns>
  ...
  <Card title="Plugins" icon="plug">
    Adicione Mattermost e muito mais com extensões.
  </Card>
...
- Integração com iMessage via imsg CLI local (macOS)
...
- WebChat e aplicativo de barra de menu para macOS
