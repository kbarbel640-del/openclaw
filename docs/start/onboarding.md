---
summary: "First-run onboarding flow for Amigo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Amigo">
...
<Step title="CLI">
  ...
  The app can install the global `amigo` CLI via npm/pnpm so terminal
