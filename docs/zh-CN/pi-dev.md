...
本指南总结了在 Amigo 中开发 Pi 集成的合理工作流程。
...
状态存储在 Amigo 状态目录下。默认为 `~/.amigo`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.amigo.ai/testing
- https://docs.amigo.ai/start/getting-started
