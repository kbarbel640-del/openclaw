...
![创建企业自建应用](/zh-CN/images/feishu-step2-create-app.png)
...
![获取应用凭证](/zh-CN/images/feishu-step3-credentials.png)
...
![配置应用权限](/zh-CN/images/feishu-step4-permissions.png)
...
![启用机器人能力](/zh-CN/images/feishu-step5-bot-capability.png)
...
![配置事件订阅](/zh-CN/images/feishu-step6-event-subscription.png)
