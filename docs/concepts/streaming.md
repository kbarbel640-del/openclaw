...
Amigo has two separate “streaming” layers:
...
When block streaming is enabled, Amigo can **merge consecutive block chunks**
...
When draft streaming is active, Amigo disables block streaming for that reply to avoid double-streaming.
