...
Use estos cuando una tarea este claramente vinculada a un script; de lo contrario, prefiera la CLI.

## Convenciones

- Los scripts son **opcionales** a menos que se referencien en la documentacion o en listas de verificacion de lanzamiento.
- Prefiera superficies de la CLI cuando existan (ejemplo: el monitoreo de autenticacion usa `openclaw models status --check`).
