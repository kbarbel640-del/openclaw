...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T06:58:57Z
---
...
están autorizados a unirse. Las UIs (app de macOS, clientes futuros) son solo frontends que
...
- **Transporte**: el endpoint WS del Gateway reenvía solicitudes, pero no decide
  la pertenencia. (El soporte heredado del puente TCP está en desuso/eliminado).
...
## Flujo de trabajo por CLI (amigable para headless)
