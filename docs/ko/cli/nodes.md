---
summary: "`openclaw nodes`에 대한 CLI 레퍼런스 (list/status/approve/invoke, camera/canvas/screen)"
read_when:
...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T06:35:30Z
---
...
현재 연결된 노드만 표시하려면 `--connected`를 사용합니다. `--last-connected <duration>`를 사용하면
