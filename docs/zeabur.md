...
summary: "Deploy Clawdbot on Zeabur with one click"
read_when:
  - Deploying to Zeabur
...
Deploy your personal AI assistant in minutes — no server setup required.
...
- **One-click deployment** — no terminal, no Docker knowledge needed
- **Flexible hosting** — use our managed servers or connect your own VPS
- **Zeabur AI Hub** — access Gemini, GPT, Claude, DeepSeek with a single API key
- **Free tier available** — get started without upfront cost
- **Automatic HTTPS** — secure by default
- **Persistent storage** — your config and sessions survive restarts
...
2. Fill in the variables:
   - **Domain**: Your preferred subdomain (e.g., `my-clawdbot.zeabur.app`)
...
2. Click the **Web UI (with token)** link — the URL includes your domain and auth token (e.g., `https://<your-domain>.zeabur.app/clawdbot?token=...`)
...
2. Check if the bot is paired: Open **Command** and run `clawdbot pairing list`
