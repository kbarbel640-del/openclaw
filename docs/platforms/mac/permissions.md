...
- Same path: run the app from a fixed location (for Amigo, `dist/Amigo.app`).
...
Workaround: move files into the Amigo workspace (`~/.amigo/workspace`) if you want to avoid per-folder grants.
