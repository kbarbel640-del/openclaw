...
- **Slug generator** (#25485) — Session slug resolved from agent's _effective_ model (including defaults/fallback chain) instead of raw agent-primary config only. Contributor: @SudeepMalipeddi.
