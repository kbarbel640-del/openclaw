...
This guide summarizes a sane workflow for working on the pi integration in Amigo.
...
- Trigger the agent directly:
  - `pnpm amigo agent --message "Hello" --thinking low`
...
State lives under the Amigo state directory. Default is `~/.amigo`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `amigo.json` for config
...
- [https://docs.amigo.ai/testing](https://docs.amigo.ai/testing)
- [https://docs.amigo.ai/start/getting-started](https://docs.amigo.ai/start/getting-started)
