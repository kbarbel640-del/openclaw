...
read_when:
  - You are building a Amigo plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (amigo.plugin.json)

Every plugin **must** ship a `amigo.plugin.json` file in the **plugin root**.
Amigo uses this manifest to validate configuration **without executing plugin
