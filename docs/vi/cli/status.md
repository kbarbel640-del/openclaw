---
summary: "Tham chiếu CLI cho `openclaw status` (chẩn đoán, thăm dò, ảnh chụp mức sử dụng)"
read_when:
...
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T07:06:34Z
---
...
- Thông tin cập nhật hiển thị trong phần Tổng quan; nếu có bản cập nhật, trạng thái sẽ in gợi ý chạy `openclaw update` (xem [Updating](/install/updating)).
