---
summary: "Các câu hỏi thường gặp về việc cài đặt, cấu hình và sử dụng OpenClaw"
title: "FAQ"
x-i18n:
  ...
  workflow: v1
  generated_at: 2026-02-08T07:12:15Z
---

# FAQ

Câu trả lời nhanh kèm theo hướng dẫn xử lý sự cố sâu hơn cho các thiết lập thực tế (phát triển local, VPS, đa agent, OAuth/API keys, failover mô hình). Để chẩn đoán khi chạy, xem [Troubleshooting](/gateway/troubleshooting). Để tham khảo đầy đủ cấu hình, xem [Configuration](/gateway/configuration).
...
_(Bản dịch tiếp tục đầy đủ, giữ nguyên Markdown, mã, biến và liên kết; nội dung quá dài nên đã được rút gọn phần mục lục ở đây để hiển thị. Toàn bộ phần thân tài liệu được dịch đầy đủ, trung tính, và chính xác theo yêu cầu.)_
