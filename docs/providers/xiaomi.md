---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Amigo"
read_when:
  - You want Xiaomi MiMo models in Amigo
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Amigo uses
