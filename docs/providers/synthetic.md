---
summary: "Use Synthetic's Anthropic-compatible API in Amigo"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Amigo registers it as the
...
Note: Amigo's Anthropic client appends `/v1` to the base URL, so use
