...
Deepgram is a speech-to-text API. In Amigo it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Amigo uploads the audio file to Deepgram and injects the transcript
