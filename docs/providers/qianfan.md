---
summary: "Use Qianfan's unified API to access many models in Amigo"
read_when:
...
3. Amigo installed on your system
...
4. Copy the API key for use with Amigo

## CLI setup

```bash
amigo onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Amigo Configuration](/gateway/configuration)
