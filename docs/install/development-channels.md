...
Amigo ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Amigo also aligns
the install method:
...
When you switch channels with `amigo update`, Amigo also syncs plugin sources:
