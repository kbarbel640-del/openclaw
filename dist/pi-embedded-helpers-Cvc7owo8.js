...
import { C as normalizeAccountId$1, E as resolveAgentIdFromSessionKey, T as normalizeMainKey, _ as DEFAULT_AGENT_ID, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, h as resolveOpenClawPackageRootSync, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, w as normalizeAgentId, y as buildAgentMainSessionKey } from "./workspace-CiMJt8ns.js";
import { F as normalizeE164, S as requireActivePluginRegistry, _ as getChatChannelMeta, h as CHAT_CHANNEL_ORDER, k as escapeRegExp, l as createSubsystemLogger, m as CHANNEL_IDS, n as runExec, ot as resolvePreferredOpenClawTmpDir, u as defaultRuntime, w as CONFIG_DIR, z as resolveUserPath } from "./exec-a7RqluET.js";
import { l as resolveSessionAgentId, n as resolveAgentConfig } from "./agent-scope-CKM5Fx2d.js";
import { G as resolveSlackReplyToMode, I as normalizeChannelId, J as normalizeChatType, R as normalizeWhatsAppTarget, V as resolveTelegramAccount, W as resolveSlackAccount, X as resolveDiscordAccount, _ as listDeliverableMessageChannels, a as resizeToJpeg, n as getImageMetadata, v as normalizeMessageChannel } from "./image-ops-CNOCC6Z9.js";
import { t as parseBooleanValue } from "./boolean-Bb19hm9Y.js";
import { t as formatCliCommand } from "./command-format-BmTFj7S4.js";
import { A as resolveWhatsAppAccount, _ as resolveEnableState, a as writeConfigFile, d as parseDurationMs, g as normalizePluginsConfig, n as loadConfig, p as loadPluginManifestRegistry, s as parseByteSize, t as createConfigIO, v as resolveMemorySlotDecision } from "./config-B1Xo0gZ9.js";
import { n as resolveSignalAccount } from "./accounts-7RpTC6Lb.js";
import { n as MANIFEST_KEY, t as LEGACY_MANIFEST_KEYS } from "./legacy-names-BWhO1_ll.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as ensureChromeExtensionRelayServer, a as resolveOpenClawUserDataDir, b as isLoopbackHost, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as getHeadersWithAuth, i as launchOpenClawChrome, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as stopChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-0sqdPv5Z.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-BS1bEBlO.js";
import { t as resolveIMessageAccount } from "./accounts-DxgmT-x2.js";
import { n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-DfJF1B42.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-JGGQViao.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DIQtEDeE.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B7nsUBO5.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-B7nsUBO5.js")).closePlaywrightBrowserConnection();
		} catch {}
