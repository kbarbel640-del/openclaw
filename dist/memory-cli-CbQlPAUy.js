...
import { A as theme, O as colorize, Z as resolveStateDir, k as isRich, o as createSubsystemLogger, p as defaultRuntime, w as setVerbose } from "./entry.js";
import { S as shortenHomePath, x as shortenHomeInString, y as resolveUserPath } from "./utils-M-vQAlGY.js";
...
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-Bp1-grKZ.js";
import { t as formatDocsLink } from "./links-Bvz_D8Gr.js";
import { r as withManager } from "./cli-utils-r6pQ5iCT.js";
import { n as withProgress, r as withProgressTotals } from "./progress-ApT6cok4.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-D4LsvJqn.js");
			...
			if (primary) {
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-ATX3L2Ui.js").then((n) => n.t);
