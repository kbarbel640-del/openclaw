    ...
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      ...
      ${t.showAdvanced?d`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              ...
              ${o("nip05","NIP-05 Identifier",{placeholder:"[redacted-email]",help:"Verifiable identifier (e.g., [redacted-email])"})}

              ${o("lud16","Lightning Address",{placeholder:"[redacted-email]",help:"Lightning address for tips (LUD-16)"})}
            </div>
          `:g}
