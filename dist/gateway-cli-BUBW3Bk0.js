...
import { t as formatCliCommand } from "./command-format-C8kcO3i7.js";
...
import { E as truncateUtf16Safe, S as shortenHomePath, n as clamp, s as ensureDir, t as CONFIG_DIR, u as isPlainObject, y as resolveUserPath } from "./utils-M-vQAlGY.js";
...
import { n as withProgress } from "./progress-ApT6cok4.js";
import "./pairing-store-Dgy_PkNT.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-6ltFPOyK.js";
import "./send-CbVU-TR-.js";
import { C as resolveAssistantAvatarUrl, S as normalizeControlUiBasePath, b as CONTROL_UI_AVATAR_PREFIX, c as handleReset, x as buildControlUiAvatarUrl } from "./onboard-helpers-B0uCYhu2.js";
import "./prompt-style-Bo1texhN.js";
import "./pairing-labels-BcVKQODN.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-CWXgq9D0.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-By_FPHpy.js";
import "./delivery-queue-CR5cV5Y4.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-C8edjgRD.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-CpOL1NkY.js";
...
import "./onboard-channels-Cd9WMYRA.js";
import "./archive-unczA8_5.js";
import "./skill-scanner-DFG_N86N.js";
import "./installs-B_b4HCzS.js";
import { t as buildChannelAccountSnapshot } from "./status-CkGK7iEK.js";
import "./channels-status-issues-BOeprosc.js";
import "./register.subclis-B58Jr0WP.js";
import "./completion-cli-p48XIBQY.js";
import "./daemon-runtime-BWlztyM0.js";
import "./service-B2_W3-9q.js";
import "./systemd-CYSZ1nIw.js";
import "./shared-BcQYewmG.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-CPWj67ce.js";
import "./diagnostics-buO4d0LP.js";
import "./service-audit-DU4Vt5En.js";
import "./table-DDJYqAIH.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DjDLlsai.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Dkl8lD-Q.js";
import { a as resolveNodeCommandAllowlist, i as isNodeCommandAllowed, o as probeGateway } from "./audit-CNdLwIt-.js";
import { m as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-BWDBwTvm.js";
import { c as startHeartbeatRunner, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-kuZS8TS7.js";
import { a as createOutboundSendDeps, i as resolveAgentOutboundTarget, o as createDefaultDeps, r as resolveAgentDeliveryPlan, s as createOutboundSendDeps$1, t as agentCommand } from "./agent-DaD8fZ8s.js";
import { a as resolveControlUiRootOverrideSync, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync } from "./health-format-Br_8JAmG.js";
import { a as checkUpdateStatus, c as resolveNpmChannelTag, g as normalizeUpdateChannel, o as compareSemverStrings, u as DEFAULT_PACKAGE_CHANNEL } from "./status.update-Dgk5DtF-.js";
import "./auth-choice-BPdtLzl_.js";
import "./github-copilot-auth-BsAan6c4.js";
import "./logging-DNs9FEv8.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-BtBohG1p.js";
import { n as forceFreePortAndWait, r as runOnboardingWizard } from "./ports-BQOKH2Xy.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CieZqW1M.js";
import "./tui-yb6CsxRg.js";
import { t as runGatewayUpdate } from "./update-runner-Q35mZ1lO.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-Bcr8m1Kh.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DAbleMpz.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D_SQfipg.js";
import { r as getStatusSummary } from "./status-D8ZdyZZM.js";
import "./node-service-C0wKWOf4.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BAtrAyaL.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-CWXgq9D0.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-NNBQcdp2.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CR5cV5Y4.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CNGP7twu.js").then((n) => n.n);
