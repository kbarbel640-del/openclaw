import { G as resolveGatewayPort, L as DEFAULT_GATEWAY_PORT, m as restoreTerminalState, p as defaultRuntime } from "./entry.js";
import { v as ensureAuthProfileStore } from "./auth-profiles-C9_xOnFy.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-C8kcO3i7.js";
import { C as sleep, h as pathExists, y as resolveUserPath } from "./utils-M-vQAlGY.js";
import { c as resolveDefaultAgentId, p as DEFAULT_BOOTSTRAP_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-BabSooVs.js";
...
import { p as findTailscaleBinary } from "./auth-HVWrOuKf.js";
import { r as resolveLsofCommandSync } from "./ports-rKsugsSD.js";
import { _ as summarizeExistingConfig, a as ensureWorkspaceAndSessions, c as handleReset, d as openUrl, f as printWizardHeader, h as resolveControlUiLinks, i as detectBrowserOpenSupport, m as randomToken, n as applyWizardMetadata, o as formatControlUiSshHint, p as probeGatewayReachable, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as validateGatewayPasswordInput, y as waitForGatewayReachable } from "./onboard-helpers-B0uCYhu2.js";
import { t as WizardCancelledError } from "./prompts-DxnxCHKt.js";
import { n as setupChannels } from "./onboard-channels-Cd9WMYRA.js";
import { r as installCompletion } from "./completion-cli-p48XIBQY.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BWlztyM0.js";
...
import { d as applyPrimaryModel, f as promptDefaultModel, r as promptRemoteGatewayConfig, s as promptCustomApiConfig, t as setupSkills } from "./onboard-skills-BWDBwTvm.js";
import { r as healthCommand } from "./health-kuZS8TS7.js";
import { n as ensureControlUiAssetsBuilt, t as formatHealthCheckFailure } from "./health-format-Br_8JAmG.js";
import { l as promptAuthChoiceGrouped, n as warnIfModelConfigLooksOff, r as applyAuthChoice, t as resolvePreferredProviderForAuthChoice } from "./auth-choice-BPdtLzl_.js";
import { n as logConfigUpdated } from "./logging-DNs9FEv8.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BtBohG1p.js";
import { t as runTui } from "./tui-yb6CsxRg.js";
import { l as ensureCompletionCacheExists, s as checkShellCompletionStatus } from "./update-runner-Q35mZ1lO.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-B_6vJdh4.js").then((n) => n.r);
