import { Ct as resolveRequiredHomeDir, G as resolveGatewayPort, I as CONFIG_PATH, K as resolveIsNixMode, N as getResolvedLoggerSettings, Y as resolveOAuthDir, Z as resolveStateDir, n as isTruthyEnvValue, p as defaultRuntime } from "./entry.js";
...
import { C as sleep, S as shortenHomePath } from "./utils-M-vQAlGY.js";
...
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-BabSooVs.js";
import { c as writeConfigFile, o as readConfigFileSnapshot } from "./config-DERbrvBI.js";
...
import { i as resolveGatewayAuth } from "./auth-HVWrOuKf.js";
import { i as formatPortDiagnostics, n as inspectPortUsage } from "./ports-rKsugsSD.js";
import { i as loadSessionStore, j as resolveMainSessionKey } from "./sessions-BJEyAc_A.js";
import { s as loadModelCatalog } from "./runner-XcgJy_ug.js";
import { S as DEFAULT_SANDBOX_IMAGE, b as DEFAULT_SANDBOX_BROWSER_IMAGE, u as resolveSandboxScope, x as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-D64T9Pyj.js";
import { c as resolveStorePath, n as resolveSessionFilePath, s as resolveSessionTranscriptsDirForAgent } from "./paths-erOp4-FP.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-NZu9U6a5.js";
import { i as readChannelAllowFromStore } from "./pairing-store-Dgy_PkNT.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-B0uCYhu2.js";
...
import { t as note$1 } from "./note-Dj9IhbC0.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-nebh58LK.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BOeprosc.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BWlztyM0.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-B2_W3-9q.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CYSZ1nIw.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-DYbd3eFX.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-buO4d0LP.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-DU4Vt5En.js";
import { r as healthCommand } from "./health-kuZS8TS7.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-Br_8JAmG.js";
import { n as logConfigUpdated } from "./logging-DNs9FEv8.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CieZqW1M.js";
import { c as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-Q35mZ1lO.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CyElHPQB.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B_6vJdh4.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-Bd-qIvCT.js";
