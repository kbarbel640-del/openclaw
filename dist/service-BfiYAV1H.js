import { I as colorize, L as isRich, R as theme } from "./subsystem-Dk9vptdH.js";
...
function resolveAndroidService() {
  const noop = (op) => async () => {
    process.stdout.write(`[android-termux] Service '${op}' skipped — use tmux to manage the gateway.
`);
  };
  return {
