...
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, r as enableConsoleCapture, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-Dk9vptdH.js";
import { C as shortenHomePath, E as toWhatsappJid, S as shortenHomeInString, b as resolveUserPath, h as normalizeE164, n as assertWebChannel, v as resolveHomeDir } from "./utils-DHNjxV7z.js";
import "./pi-embedded-helpers-VKUwj79_.js";
import { B as CHANNEL_MESSAGE_ACTION_NAMES, R as formatTargetDisplay, ft as CHANNEL_TARGETS_DESCRIPTION, j as runMessageAction, pt as CHANNEL_TARGET_DESCRIPTION, rn as registerMemoryCli, t as getReplyFromConfig, wt as resolveCommitHash, yr as lookupContextTokens } from "./reply-CyQ6-FzJ.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-BWxPj0z_.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BDA_Yyrr.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-9Xp7ERv_.js";
import { At as normalizeOptionalSecretInput, Ct as ensureAuthProfileStore, Et as resolveAuthStorePath, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, W as resolveEnvApiKey, d as resolveConfiguredModelRef, ft as resolveApiKeyForProfile, jt as normalizeSecretInput, s as normalizeProviderId, st as resolveAuthProfileOrder, xt as upsertAuthProfile } from "./model-selection-LGcPfPYa.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-BglTbubH.js";
import { F as loadDotEnv, P as VERSION, c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BFqIpIaN.js";
...
import { O as resolveFreshSessionTotalTokens, b as deriveSessionKey, i as loadSessionStore, s as saveSessionStore, x as resolveSessionKey } from "./sessions-C0GO_mnr.js";
import { d as installUnhandledRejectionHandler, v as applyTemplate } from "./runner-CVeKzZQO.js";
...
import { i as handlePortError, n as describePortOwner, r as ensurePortAvailable, t as PortInUseError } from "./ports-DA9qgGkH.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-Dy2obPV0.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-x2d8LpLG.js";
...
import { a as ensureWorkspaceAndSessions, c as handleReset, d as openUrl, h as resolveControlUiLinks, i as detectBrowserOpenSupport, l as moveToTrash, m as randomToken, n as applyWizardMetadata, o as formatControlUiSshHint, t as DEFAULT_WORKSPACE, y as waitForGatewayReachable } from "./onboard-helpers-BndGbHB5.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BPRtWYv8.js";
import "./pairing-labels-Uz954oAX.js";
import "./session-cost-usage-CbsU4YHL.js";
import "./nodes-screen-ByxT3UnR.js";
import { _ as promptYesNo, g as ensureBinary } from "./auth-BL5l-UZW.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-BZ63BOuY.js";
import "./outbound-BYf8x1XJ.js";
import "./session-ZK5DQpmS.js";
import "./login-DQDznI1D.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, o as createDefaultDeps, t as agentCommand } from "./agent-CSaVA6iH.js";
import { t as isMainModule } from "./is-main-DG1nblbE.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DOV1XZPj.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CmYQGnpZ.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, o as findAgentEntryIndex, r as runOnboardingWizard, s as listAgentEntries, t as statusCommand, u as identityHasValues } from "./status-D9mVa_cU.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BhPq-84u.js";
import { t as formatHelpExamples } from "./help-format-B0geaHf1.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-28CRTwys.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-CDE72vl0.js";
import "./note-NSn6jB2X.js";
import { t as WizardCancelledError } from "./prompts-BEHxUC3w.js";
import { t as createClackPrompter } from "./clack-prompter-BsHdGd_U.js";
import { S as promptAuthChoiceGrouped, _ as applyAuthChoice, a as CustomApiError, b as detectZaiEndpoint, g as warnIfModelConfigLooksOff, l as resolveCustomProviderId, o as applyCustomApiConfig, s as parseNonInteractiveCustomApiFlags, v as applyOpenAIConfig, x as applyGoogleGeminiModelDefault, y as upsertSharedEnvVar } from "./onboard-skills-BmqWn-kz.js";
import { B as applyVeniceConfig, C as applyAuthProfileConfig, Ct as setXiaomiApiKey, E as applyKimiCodeConfig, Ft as validateAnthropicSetupToken, H as applyXaiConfig, I as applySyntheticConfig, J as applyLitellmConfig, K as applyZaiConfig, M as applyOpenrouterConfig, O as applyMoonshotConfig, P as applyQianfanConfig, Pt as buildTokenProfileId, Q as applyVercelAiGatewayConfig, R as applyTogetherConfig, St as setXaiApiKey, W as applyXiaomiConfig, X as applyCloudflareAiGatewayConfig, _ as applyOpencodeZenConfig, _t as setQianfanApiKey, bt as setVeniceApiKey, ct as setCloudflareAiGatewayConfig, dt as setKimiCodingApiKey, ft as setLitellmApiKey, gt as setOpenrouterApiKey, ht as setOpencodeZenApiKey, k as applyMoonshotConfigCn, lt as setGeminiApiKey, mt as setMoonshotApiKey, pt as setMinimaxApiKey, st as setAnthropicApiKey, ut as setHuggingfaceApiKey, vt as setSyntheticApiKey, w as applyHuggingfaceConfig, wt as setZaiApiKey, x as applyMinimaxConfig, xt as setVercelAiGatewayApiKey, y as applyMinimaxApiConfig, yt as setTogetherApiKey } from "./github-copilot-auth-CJCZuWSb.js";
import { n as setupChannels } from "./onboard-channels-B83-X3W1.js";
import "./plugin-auto-enable-C8GEfHVS.js";
import "./archive-B67f2Ap7.js";
import "./skill-scanner-CfiKJfi5.js";
import "./installs-CafUpMf3.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-BCqckM8y.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-BbAl8VsI.js";
import { r as healthCommand } from "./health-CQhnp1V0.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-E6QtDbZX.js";
import { t as resolveGatewayService } from "./service-BfiYAV1H.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-DpdIZi-t.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-BlWkqpnA.js";
import "./widearea-dns-CC45C3PK.js";
import "./skills-status-DyGXSZH4.js";
import "./auth-health-CfPiFHzp.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-e5NyqrHK.js";
import { c as registerSubCliCommands, d as hasHelpOrVersion, l as getCommandPath, u as getVerboseFlag } from "./completion-cli-DwruOlWb.js";
import "./status.update-Bme73dB0.js";
import "./service-audit-CPwd_mLZ.js";
import "./channels-status-issues-BXLrUZ9v.js";
import { t as renderTable } from "./table-BA7WnaL5.js";
import "./hooks-status-TLRbC3Pt.js";
import "./tui-BHOTs34v.js";
import "./audit-BtAIRrBR.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-E6QtDbZX.js").then((n) => n.t);
