import { J as logVerbose, X as shouldLogVerbose, n as runExec } from "./exec-BhtJ_oeB.js";
import { H as resolveOpenClawAgentDir, S as resolveApiKeyForProvider, f as normalizeGoogleModelId, o as normalizeProviderId, x as requireApiKey } from "./model-selection-C5uBHvBr.js";
import { C as detectMime, D as isAudioFileName, T as getFileExtension, k as kindFromMime, q as normalizeChatType } from "./image-ops-C7_aZYD2.js";
import { n as loadConfig } from "./config-D-m2JC0t.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-C4skWsoQ.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-D1SGLLcP.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CJmheYUS.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
