...
import { n as listKnownProfileNames, o as resolveBrowserConfig, s as resolveProfile, t as createBrowserRouteContext } from "./server-context-BNtjuKAn.js";
import { _ as ensureChromeExtensionRelayServer } from "./chrome-DFsbt9ef.js";
import { t as ensureBrowserControlAuth } from "./control-auth-Batqdqdc.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-DpKtlFaO.js")).closePlaywrightBrowserConnection();
	} catch {}
}
