...
if (!ensureExperimentalWarningSuppressed()) {
	...
	import("./run-main-Cj2y2udF.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { CHANNEL_IDS as $, theme as A, resolveCanonicalConfigPath as B, logVerboseConsole as C, resolveRequiredHomeDir as Ct, warn as D, success as E, normalizeLogLevel as F, resolveGatewayPort as G, resolveConfigPathCandidate as H, CONFIG_PATH as I, resolveNewStateDir as J, resolveIsNixMode as K, DEFAULT_GATEWAY_PORT as L, getLogger as M, getResolvedLoggerSettings as N, colorize as O, toPinoLikeLogger as P, resolvePreferredOpenClawTmpDir as Q, STATE_DIR as R, logVerbose as S, resolveEffectiveHomeDir as St, shouldLogVerbose as T, resolveDefaultConfigCandidates as U, resolveConfigPath as V, resolveGatewayLockDir as W, resolveOAuthPath as X, resolveOAuthDir as Y, resolveStateDir as Z, unregisterActiveProgressLine as _, getVerboseFlag as _t, parseBooleanValue as a, listChatChannels as at, isVerbose as b, normalizeProfileName as bt, enableConsoleCapture as c, normalizeChatChannelId as ct, shouldLogSubsystemToConsole as d, setActivePluginRegistry as dt, CHAT_CHANNEL_ORDER as et, visibleWidth as f, buildParseArgv as ft, registerActiveProgressLine as g, getPrimaryCommand as gt, clearActiveProgressLine as h, getPositiveIntFlagValue as ht, normalizeEnv as i, getChatChannelMeta as it, getChildLogger as j, isRich as k, setConsoleSubsystemFilter as l, getActivePluginRegistry as lt, restoreTerminalState as m, getFlagValue as mt, isTruthyEnvValue as n, formatChannelPrimerLine as nt, createSubsystemLogger as o, normalizeAnyChannelId as ot, defaultRuntime as p, getCommandPath as pt, resolveLegacyStateDirs as q, logAcceptedEnvOption as r, formatChannelSelectionLine as rt, runtimeForLogger as s, normalizeChannelId as st, installProcessWarningFilter as t, DEFAULT_CHAT_CHANNEL as tt, setConsoleTimestampPrefix as u, requireActivePluginRegistry as ut, danger as v, hasFlag as vt, setVerbose as w, isYes as x, expandHomePrefix as xt, info as y, hasHelpOrVersion as yt, isNixMode as z };