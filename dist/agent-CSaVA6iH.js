import { c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL } from "./subsystem-Dk9vptdH.js";
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-VKUwj79_.js";
import { At as getRemoteSkillEligibility, Cn as AGENT_LANE_NESTED, I as resolveOutboundTarget, L as resolveSessionDeliveryTarget, On as registerAgentRunContext, Sr as applyVerboseOverride, Tn as emitAgentEvent, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, Vr as resolveAgentTimeoutMs, br as clearSessionAuthProfileOverride, i as runCliAgent, l as runEmbeddedPiAgent, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, wn as clearAgentRunContext, xr as applyModelOverrideToSessionEntry, yr as lookupContextTokens } from "./reply-CyQ6-FzJ.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-9Xp7ERv_.js";
import { Ct as ensureAuthProfileStore, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, o as modelKey, t as buildAllowedModelSet } from "./model-selection-LGcPfPYa.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { i as loadConfig } from "./config-BFqIpIaN.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BqubgBzU.js";
import { C as resolveChannelResetConfig, S as evaluateSessionFreshness, T as resolveSessionResetType, i as loadSessionStore, j as resolveExplicitAgentSessionKey, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetPolicy, x as resolveSessionKey } from "./sessions-C0GO_mnr.js";
import { s as loadModelCatalog } from "./runner-CVeKzZQO.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-ClV79GKX.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Dy2obPV0.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-BuQbsACT.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-Ck5K5MKu.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("./web-Dg1qtlTL.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("./send-ClHUFnHH.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("./send-B_pFBnxc.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("./send-Di4Ur3tq.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("./send-BZlBXGH7.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("./send-WO5xvV3w.js").then((n) => n.n);
