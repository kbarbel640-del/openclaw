...
import { E as resolveAgentIdFromSessionKey, T as normalizeMainKey, l as ensureAgentWorkspace, w as normalizeAgentId } from "../../workspace-CiMJt8ns.js";
import { g as DEFAULT_CHAT_CHANNEL, l as createSubsystemLogger, u as defaultRuntime } from "../../exec-a7RqluET.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds } from "../../agent-scope-CKM5Fx2d.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads, w as SILENT_REPLY_TOKEN } from "../../deliver-DoqeFT_8.js";
...
import { I as normalizeChannelId, P as getChannelPlugin, b as resolveMessageChannel, f as INTERNAL_MESSAGE_CHANNEL, h as isInternalMessageChannel, m as isGatewayMessageChannel, p as isDeliverableMessageChannel, v as normalizeMessageChannel } from "../../image-ops-CNOCC6Z9.js";
import "../../boolean-Bb19hm9Y.js";
import { C as modelKey, E as resolveConfiguredModelRef, L as DEFAULT_CONTEXT_TOKENS, R as DEFAULT_MODEL, S as isCliProvider, h as ensureAuthProfileStore, k as resolveThinkingDefault, y as buildAllowedModelSet, z as DEFAULT_PROVIDER } from "../../model-auth-BkZQl1VS.js";
import { t as formatCliCommand } from "../../command-format-BmTFj7S4.js";
import { n as loadConfig } from "../../config-B1Xo0gZ9.js";
...
import { n as resolveSessionFilePath, s as resolveStorePath } from "../../paths-DfJF1B42.js";
...
import { s as loadModelCatalog } from "../../runner-CGtwfu-7.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("../../web-Bf5WmFms.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("../../send-D1qz65-z.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("../../send-Vi3Q-r6l.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("../../send-DikgY_ip.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("../../send-CE6-rIOZ.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("../../send-D9An4ZuK.js").then((n) => n.n);
