...
import { C as resolveOpenClawPackageRootSync, D as buildAgentMainSessionKey, M as normalizeAgentId, N as normalizeMainKey, P as resolveAgentIdFromSessionKey, T as DEFAULT_AGENT_ID, _ as DEFAULT_TOOLS_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, j as normalizeAccountId$1, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, w as DEFAULT_ACCOUNT_ID, y as ensureAgentWorkspace } from "./agent-scope-CVeVRfcx.js";
import { C as CONFIG_DIR, I as resolveConfigDir, O as escapeRegExp, P as normalizeE164, R as resolveUserPath, at as resolvePreferredOpenClawTmpDir, g as getChatChannelMeta, h as CHAT_CHANNEL_ORDER, l as createSubsystemLogger, m as CHANNEL_IDS, n as runExec, u as defaultRuntime, x as requireActivePluginRegistry } from "./exec-BhtJ_oeB.js";
import { j as parseBooleanValue } from "./model-selection-C5uBHvBr.js";
import { t as formatCliCommand } from "./command-format-qUVxzqYm.js";
import { B as resolveTelegramAccount, C as detectMime, F as normalizeChannelId, L as normalizeWhatsAppTarget, U as resolveSlackAccount, W as resolveSlackReplyToMode, Y as resolveDiscordAccount, _ as normalizeMessageChannel, a as resizeToJpeg, g as listDeliverableMessageChannels, n as getImageMetadata, q as normalizeChatType, w as extensionForMime } from "./image-ops-C7_aZYD2.js";
import { M as resolveWhatsAppAccount, a as writeConfigFile, b as resolveMemorySlotDecision, d as parseDurationMs, g as MANIFEST_KEY, h as LEGACY_MANIFEST_KEYS, n as loadConfig, p as loadPluginManifestRegistry, s as parseByteSize, t as createConfigIO, v as normalizePluginsConfig, y as resolveEnableState } from "./config-D-m2JC0t.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as ensureChromeExtensionRelayServer, a as resolveOpenClawUserDataDir, b as isLoopbackHost, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as getHeadersWithAuth, i as launchOpenClawChrome, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as stopChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-Dvu_G76W.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-B8y79jwX.js";
import { n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-sLLb4Iy0.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BiU0SOrl.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DoCjYzGJ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Cm4vp4bu.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-Cm4vp4bu.js")).closePlaywrightBrowserConnection();
		} catch {}
