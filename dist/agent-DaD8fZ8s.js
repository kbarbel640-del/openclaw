...
import { A as modelKey, F as resolveConfiguredModelRef, Mt as DEFAULT_CONTEXT_TOKENS, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, T as buildAllowedModelSet, k as isCliProvider, v as ensureAuthProfileStore, z as resolveThinkingDefault } from "./auth-profiles-C9_xOnFy.js";
...
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-BabSooVs.js";
import { i as loadConfig } from "./config-DERbrvBI.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Bj04t2xy.js";
import { At as getRemoteSkillEligibility, Cn as clearAgentRunContext, Dn as registerAgentRunContext, I as resolveOutboundTarget, L as resolveSessionDeliveryTarget, Sn as AGENT_LANE_NESTED, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, cr as clearSessionAuthProfileOverride, i as runCliAgent, kr as resolveAgentTimeoutMs, l as runEmbeddedPiAgent, lr as applyModelOverrideToSessionEntry, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, ur as applyVerboseOverride, wn as emitAgentEvent } from "./reply-9YUII82G.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-C6pzZhm1.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-CNGP7twu.js";
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-C1-1-U6z.js";
import { A as resolveExplicitAgentSessionKey, C as resolveSessionResetPolicy, S as resolveChannelResetConfig, b as resolveSessionKey, i as loadSessionStore, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetType, x as evaluateSessionFreshness } from "./sessions-BJEyAc_A.js";
import { s as loadModelCatalog } from "./runner-XcgJy_ug.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-DQyYx0by.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-erOp4-FP.js";
import { t as lookupContextTokens } from "./context-CGQcAzA9.js";
import { l as deriveSessionTotalTokens, u as hasNonzeroUsage } from "./session-cost-usage-CWXgq9D0.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("./web-BSBL79-J.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("./send-Cwo7YumQ.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("./send-DWM7RrpW.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("./send-BPz2yf20.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("./send-D-mTESpD.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("./send-CbVU-TR-.js").then((n) => n.n);
