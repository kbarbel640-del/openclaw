...
import { g as pathExists } from "./utils-DHNjxV7z.js";
...
const loadConfig = async () => {
	return (await import("./config-BFqIpIaN.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-BmwjWuD5.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		register: async (program) => {
			(await import("./gateway-cli-9OgQj19v.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-C1jCU-4J.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-DUiM4keB.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		register: async (program) => {
			(await import("./system-cli-DzQovMJa.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		register: async (program) => {
			(await import("./models-cli-DaIaQUBI.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		register: async (program) => {
			(await import("./exec-approvals-cli-IPM9_OKN.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		register: async (program) => {
			(await import("./nodes-cli-rjfMPufm.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		register: async (program) => {
			(await import("./devices-cli-DVJs2irL.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		register: async (program) => {
			(await import("./node-cli-Dq15WKxx.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		register: async (program) => {
			(await import("./sandbox-cli-znbr41Qn.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-B_9qLde4.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		register: async (program) => {
			(await import("./cron-cli-CoxqCH-d.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		register: async (program) => {
			(await import("./dns-cli-BuQeKawT.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		register: async (program) => {
			(await import("./docs-cli-CcDfXwF3.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		register: async (program) => {
			(await import("./hooks-cli-CCG0CMz5.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		register: async (program) => {
			(await import("./webhooks-cli-CbZeBG01.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "pairing",
		...
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-DvDoKT1k.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-B1akWUbl.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		register: async (program) => {
			(await import("./plugins-cli-CLBZIh8H.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DvDoKT1k.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-B6h8vnFX.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		register: async (program) => {
			(await import("./directory-cli-wbXuILXN.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		register: async (program) => {
			(await import("./security-cli-DwOCP2u1.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		register: async (program) => {
			(await import("./skills-cli-DM8Y5oAx.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		register: async (program) => {
			(await import("./update-cli-xCWfBlgu.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
...
//#endregion
export { resolveCompletionCachePath as a, registerSubCliCommands as c, hasHelpOrVersion as d, isCompletionInstalled as i, getCommandPath as l, completion_cli_exports as n, resolveShellFromEnv as o, installCompletion as r, usesSlowDynamicCompletion as s, completionCacheExists as t, getVerboseFlag as u };