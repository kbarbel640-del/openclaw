...
- TUI: guard root-container rendering by truncating over-width lines (including ANSI/CJK text) so pi-tui no longer crashes when a rendered line exceeds terminal width. (#17525) Thanks @Phineas1500.
