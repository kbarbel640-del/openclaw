...
- Config/Schema: add Grok to the documented `tools.web.search.provider` options in `schema.help.ts` so `openclaw doctor` and autocomplete include it. (#19976) Thanks @arosstale.
