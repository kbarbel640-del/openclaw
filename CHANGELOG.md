...
- Sessions/UI: preserve session labels through `/new` resets and expose reset history (`resetCount`/`lastResetAt`) in sessions list responses and Control UI so reset behavior is visible. (#23860) Thanks @maxpetrusenko.
