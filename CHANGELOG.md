...
- Gateway/Heartbeat: suppress tool error summaries from HEARTBEAT_OK auto-replies so routine keep-alive messages don't surface internal errors to users. (#20031) Thanks @arosstale.
