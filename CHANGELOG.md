...
- Agents/Subagents: ensure subagents inherit the parent agent's resolved model when no explicit model override is set, preventing silent fallback to the global default. (#20000) Thanks @arosstale.
