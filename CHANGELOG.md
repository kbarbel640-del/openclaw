...
- Telegram: stop discarding DM topic `message_thread_id` so Telegram Premium DM-topic replies land in the correct thread instead of the top-level chat. (#18168)
