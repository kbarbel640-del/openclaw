...
- Gateway/Security: add a critical-approval gate for high-risk elevated exec allow decisions with optional Control UI origin enforcement and break-glass approval codes. (#23828) Thanks @bmendonca3.
