...
- Export/Session: restore literal `{{...}}` JavaScript template placeholders in exported session HTML so runtime template substitution injects scripts correctly and exported pages no longer lose JS behavior. (#23852) Thanks @rgr4y.
