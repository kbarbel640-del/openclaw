...
- Process/Windows: add `windowsHide: true` to all subprocess spawns in `exec.ts` and `kill-tree.ts` to suppress console window flashes on Windows. (#22147) Thanks @arosstale.
