...
### Fixes
- Fetch/Windows: sanitize outgoing HTTP request headers containing non-Latin1 characters to prevent ByteString crash in Node undici fetch on Windows. (#24496) Thanks @arosstale.
