...
- Windows/Fetch: sanitize HTTP header values to strip non-Latin1 characters (> U+00FF) that crash Node's undici fetch with ByteString errors. (#25225) Thanks @arosstale.
