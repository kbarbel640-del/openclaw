...
- Docs/Development: publish an official `/development/*` docs section (index, architecture, developer-reference, changelog-analysis, agent-guidelines, and deep-dive analysis pages) synced to the released `v2026.2.26` docs corpus. (#25531) Thanks @mudrii.
