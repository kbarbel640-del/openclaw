...
- Agents/Ollama: preserve provider API for discovered models so custom Ollama entries no longer resolve with `model.api = undefined` and crash `mapOptionsForApi`. (#21977, #20259) Thanks @graysurf and @tylerhuff.
