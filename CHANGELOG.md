...
- Discord/Gateway: run message handling off the Carbon gateway event queue with bounded concurrency, queue backpressure, and per-message timeouts so slow handlers cannot stall all inbound Discord events. (#23857) Thanks @sypsyp97.
