...
=======
- Telegram/Media: fix media attachments with local file paths failing the security policy � copy files via `saveMediaBuffer` before building inbound context. (#20032) Thanks @arosstale.
>>>>>>> d23b177d82 (fix: expand sendMedia params for oxfmt line-length)
