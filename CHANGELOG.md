...
- UI/Tests: fix 3 failing unit test assertions in dashboard-v2 — update chat subtitle i18n check, fix stop button selector (SVG icon, not text), remove stale "New session" button test for removed UI element. Thanks @arosstale.
