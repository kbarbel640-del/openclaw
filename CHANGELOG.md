...
- Doctor/Upgrades: add a reusable breaking-change upgrade check framework in `openclaw doctor`, and seed it with Telegram `groupPolicy=\"allowlist\"` migration guidance when sender allowlists are missing.
