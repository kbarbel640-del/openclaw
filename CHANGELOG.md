...
- Agents/Channels: suppress reasoning/thinking blocks from channel delivery (iMessage, Telegram, Discord, etc.) so internal chain-of-thought is never forwarded to end users. (#18667)
