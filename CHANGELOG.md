...
- Windows/Process: add `windowsHide:true` to all spawn/execFile/taskkill sites to suppress visible console window flashes during exec tool calls. (#25153) Thanks @arosstale.
