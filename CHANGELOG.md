...
- Cron/AT: reschedule `@at` jobs correctly after config reload by persisting the next-run time and skipping jobs that have already fired in the current window. (#19975) Thanks @arosstale.
