...
- Windows/Exec: resolve `.cmd` and `.bat` wrappers via PATHEXT on Windows so tools like `npx` and `pnpm` can be invoked without specifying file extension. (#19987) Thanks @arosstale.
