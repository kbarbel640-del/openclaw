...
export async function handleFeishuMessage(params: {
  ...
  try {
    ...
    // Merge permission error notification into main message body to avoid duplicate replies
    if (permissionErrorForAgent) {
      ...
      messageBody = `${permissionNotifyBody}\n\n${messageBody}`;
      log(`feishu[${account.accountId}]: merged permission error into main dispatch`);
    }
