...
export function listMattermostAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AmigoConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AmigoConfig): ResolvedMattermostAccount[] {
