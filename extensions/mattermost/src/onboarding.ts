import type { ChannelOnboardingAdapter, AmigoConfig, WizardPrompter } from "amigo/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.amigo.ai/channels/mattermost",
    ].join("\n"),
