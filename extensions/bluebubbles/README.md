...
This directory contains the **BlueBubbles external channel plugin** for Amigo.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `amigo/plugin-sdk` helpers.
