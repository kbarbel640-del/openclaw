...
export function listBlueBubblesAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AmigoConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AmigoConfig): ResolvedBlueBubblesAccount[] {
