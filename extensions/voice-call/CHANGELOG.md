...
- Version alignment with core Amigo release numbers.
...
- First public release of the @amigo/voice-call plugin.
...
- CLI: `amigo voicecall` commands (call/start/continue/speak/end/status/tail/expose).
