...
export function listGoogleChatAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AmigoConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AmigoConfig): ResolvedGoogleChatAccount[] {
