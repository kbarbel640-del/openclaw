...
import type { WecomWebhookTarget, StreamState, PendingInbound } from "./types.js";
...
// Set up the flush handler at module load time
 ...
 */
export async function flushPending(pending: PendingInbound): Promise<void> {
