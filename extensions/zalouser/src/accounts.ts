...
export function listZalouserAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AmigoConfig): string {
...
function mergeZalouserAccountConfig(cfg: AmigoConfig, accountId: string): ZalouserAccountConfig {
