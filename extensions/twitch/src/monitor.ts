...
import type { ReplyPayload, AmigoConfig } from "amigo/plugin-sdk";
import { createReplyPrefixOptions } from "amigo/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AmigoConfig;
