import type { AmigoConfig } from "amigo/plugin-sdk";
...
export function listZaloAccountIds(cfg: AmigoConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: AmigoConfig): string {
...
function mergeZaloAccountConfig(cfg: AmigoConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AmigoConfig): ResolvedZaloAccount[] {
