 ...
 *
 * Provides integration with Arcade.dev for authorized tools (even more with useApiTools) including:
...
const arcadePlugin = {
  id: "arcade",
  name: "Arcade.dev",
  description: "Connect to Arcade.dev for authorized tools (Gmail, Slack, GitHub, etc.)",
