...
Nostr DM channel plugin for Amigo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Amigo. It enables your bot to:
...
# Configure amigo to use local relay
