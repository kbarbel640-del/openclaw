...
import type { AmigoPluginApi, AmigoPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "amigo-lobster-plugin-") {
...
function fakeApi(overrides: Partial<AmigoPluginApi> = {}): AmigoPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<AmigoPluginToolContext> = {}): AmigoPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: AmigoPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
