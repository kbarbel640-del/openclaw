#!/usr/bin/env python3
"""
Generate video with ElevenLabs voice (George)
"""
import os
from moviepy import *
...
VOICE_FILE = f"{OUTPUT_DIR}/voice_elevenlabs.mp3"
BGM_FILE = f"{SKILL_DIR}/assets/bgm.mp3"
OUTPUT_FILE = f"{OUTPUT_DIR}/video-03-elevenlabs.mp4"
...
# ElevenLabs voice timing (from whisper)
# Adjusted for better visual sync
SUBTITLES = [
    (0.00, 1.50, "你用 AI 省下的時間", False),
    (1.50, 3.32, "最後都去刷抖音了", False),
    (3.98, 5.00, "別騙自己", True),
    (5.00, 6.60, "AI 不是讓你變強", False),
    (6.60, 8.10, "是讓你更會逃避", False),
    (8.80, 10.00, "真正的用法？", False),
    (10.00, 11.00, "買回注意力", True),
    (11.00, 12.12, "不是時間", True),
]
...
print("🎬 Creating video with ElevenLabs voice (George)...")
