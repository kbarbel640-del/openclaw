#!/usr/bin/env python3
"""
Generate video with correctly spliced voice
"""
import os
from moviepy import *
...
VOICE_FILE = f"{OUTPUT_DIR}/voice_correct.mp3"
BGM_FILE = f"{SKILL_DIR}/assets/bgm.mp3"
OUTPUT_FILE = f"{OUTPUT_DIR}/video-08-correct.mp4"
...
# Timing after correct splice:
# 0-0.70: 你用
# 0.70-0.95: AI (George, 0.25s)
# 0.95-6.39: 省下的時間...別騙自己 (5.44s)
# 6.39-6.69: AI (George, 0.30s)
# 6.69-end: 不是讓你變強...

SUBTITLES = [
    (0.00, 0.95, "你用 AI", False),
    (0.95, 1.85, "省下的時間", False),
    (1.85, 3.60, "最後都去刷抖音了", False),
    (3.60, 6.39, "別騙自己", True),
    (6.39, 8.50, "AI 不是讓你變強", False),
    (8.50, 10.00, "是讓你更會逃避", False),
    (10.00, 12.20, "真正的用法？", False),
    (12.20, 14.00, "買回注意力", True),
    (14.00, 15.64, "不是時間", True),
]
...
print("🎬 Creating video with correct splice...")
