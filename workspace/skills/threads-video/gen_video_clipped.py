#!/usr/bin/env python3
"""
Generate video with clipped AI (first AI clip replaces second)
"""
import os
from moviepy import *
...
VOICE_FILE = f"{OUTPUT_DIR}/voice_clipped.mp3"
BGM_FILE = f"{SKILL_DIR}/assets/bgm.mp3"
OUTPUT_FILE = f"{OUTPUT_DIR}/video-09-clipped.mp4"
...
# Timing: original 0-6.36 + AI clip 0.22s + original 6.72-end
# Second AI now at 6.36-6.58 (0.22s shorter than original 0.36s)
SUBTITLES = [
    (0.00, 1.72, "你用 AI 省下的時間", False),
    (1.72, 3.42, "最後都去刷抖音了", False),
    (3.42, 5.24, "別騙自己", True),
    (5.24, 6.36, "", False),  # pause
...
print("🎬 Creating video with clipped AI...")
