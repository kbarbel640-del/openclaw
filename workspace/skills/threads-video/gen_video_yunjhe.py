#!/usr/bin/env python3
"""
Generate video with YunJhe voice (Edge TTS Taiwan male)
"""
import os
from moviepy import *
...
VOICE_FILE = f"{OUTPUT_DIR}/voice_yunjhe.mp3"
BGM_FILE = f"{SKILL_DIR}/assets/bgm.mp3"
OUTPUT_FILE = f"{OUTPUT_DIR}/video-04-yunjhe.mp4"
...
# YunJhe voice timing (from whisper)
SUBTITLES = [
...
print("🎬 Creating video with YunJhe voice (Edge TTS)...")
