...
// Component: Agent Plan
// Search Query: "workflow DAG graph nodes"
// NOTE: This is an excellent component for workstream task visualization with hierarchies,
// status toggles, MCP server tool badges, and smooth animations.
