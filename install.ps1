...
# Usage: iwr -useb https://raw.githubusercontent.com/luolin-ai/openclawWeComzh/main/install.ps1 | iex
#        & ([scriptblock]::Create((iwr -useb https://raw.githubusercontent.com/luolin-ai/openclawWeComzh/main/install.ps1))) -Tag beta -NoOnboard -DryRun
    ...
    try {
        ...
        if ($LASTEXITCODE -ne 0) {
            ...
            if ($npmOutput -match "spawn git" -or $npmOutput -match "ENOENT.*git") {
                ...
                Write-Host "  iwr -useb https://raw.githubusercontent.com/luolin-ai/openclawWeComzh/main/install.ps1 | iex" -ForegroundColor Cyan
            }
...
function Install-OpenClawFromGit {
    ...
    $repoUrl = "https://github.com/luolin-ai/openclawWeComzh.git"
